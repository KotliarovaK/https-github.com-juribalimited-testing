...
Scenario Outline: Evergreen Jnr_QueryString_SortByKeys
Runs Evergreen URL query strings which include being sorted by object key columns.
	...
	| Admin User     | admin    | m!gration |


@Evergreen @QueryStrings
Scenario Outline: Evergreen Jnr_QueryString_AllLists
...
@Evergreen @QueryStrings
Scenario Outline: Evergreen Jnr_QueryString_DateCombo_And_Apostrophe
...
@Evergreen @QueryStrings
Scenario Outline: Evergreen Jnr_QueryString_Complex
