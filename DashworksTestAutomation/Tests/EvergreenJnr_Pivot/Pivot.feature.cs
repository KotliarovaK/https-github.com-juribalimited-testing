...
namespace DashworksTestAutomation.Tests.EvergreenJnr_Pivot
{
    ...
    public partial class PivotFeature
    {
        ...
        [NUnit.Framework.TestCaseAttribute("Devices", "Region", "Babel(Engl: Initiation", "CPU Count", "Region", null)]
        [NUnit.Framework.TestCaseAttribute("Users", "Region", "EmailMigra: Migration", "Compliance", "Region", null)]
        [NUnit.Framework.TestCaseAttribute("Mailboxes", "Language", "EmailMigra: Migration", "EmailMigra: Readiness", "Language", null)]
        [NUnit.Framework.TestCaseAttribute("Applications", "Import", "UserEvergr: Stage 3", "DeviceSche: Readiness", "Import", null)]
        ...
        private void EvergreenJnr_AllLists_CheckThatProjectStageColumnsDisplayInTheCorrectOrderInternal(string listName, string rowGroups, string columns, string values, string sortedColumn, string[] exampleTags)
        {
            ...
            testRunner.Then(string.Format("data in the table is sorted by \"{0}\" column in ascending order by default for the" +
                        " Pivot", sortedColumn), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            this.ScenarioCleanup();
        }
        ...
        [NUnit.Framework.TestCaseAttribute("Devices", "Inventory Site", "Compliance", "1803: Readiness", "Inventory Site", null)]
        [NUnit.Framework.TestCaseAttribute("Users", "Domain", "Compliance", "UserEvergr: Readiness", "Domain", null)]
        [NUnit.Framework.TestCaseAttribute("Applications", "Vendor", "Compliance", "Import", "Vendor", null)]
        ...
        private void EvergreenJnr_DevicesList_CheckThatThePivotPanelShowNoFiltersAppliedIfThatWereAppliedToTheCustomListInternal()
        {
            ...
            testRunner.When("User add \"Application Compliance\" filter where type is \"Equals\" with added column" +
                    " and following value:", ((string)(null)), table78, "When ");
        ...
        private void EvergreenJnr_DevicesList_CheckResetButtonOnPivotInternal()
        {
            ...
            table82.AddRow(new string[] {
                        "Owner City"});
            testRunner.And("User adds the following \"Columns\" on Pivot:", ((string)(null)), table82, "And ");
            testRunner.Then("reset button on main panel is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table86.AddRow(new string[] {
                        "Hostname"});
            testRunner.When("User selects the following Row Groups on Pivot:", ((string)(null)), table86, "When ");
            ...
            testRunner.When("User selects the following Row Groups on Pivot:", ((string)(null)), table89, "When ");
        ...
        private void EvergreenJnr_DevicesList_CheckThatPivotPanelIsDisplayedCorrectlyAfterClicksOnManagerButtonInternal()
        {
            ...
            table92.AddRow(new string[] {
                        "Application Compliance"});
            testRunner.When("User selects the following Row Groups on Pivot:", ((string)(null)), table92, "When ");
        ...
        private void EvergreenJnr_DevicesList_CheckThatAddingColumnOnPivotIsWorksCorrectlyForFilteredListInternal()
        {
            ...
            testRunner.When("User add \"Device Key\" filter where type is \"Equals\" with added column and followi" +
                    "ng value:", ((string)(null)), table95, "When ");
