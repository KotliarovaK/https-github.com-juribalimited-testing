...
namespace DashworksTestAutomation.Tests.EvergreenJnr_Pivot
{
    ...
    public partial class PivotFeature
    {
        ...
        [NUnit.Framework.TestCaseAttribute("Devices", "Hostname", "DeviceSche: Bucket", "Building", "Boot Up Date", "Device", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Users", "Common Name", "UserSchedu: Application Readiness", "Cost Centre", "Description", "User", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Mailboxes", "Alias", "Department Name", "Country", "Display Name", "Mailbox", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Applications", "Vendor", "Babel(Engl: Category", "Application Key", "Application Key", "Application", new string[0])]
        ...
        [NUnit.Framework.CategoryAttribute("Pivot")]
        [NUnit.Framework.CategoryAttribute("DAS13747")]
        [NUnit.Framework.TestCaseAttribute("Devices", "Compliance", "Babel(Engl: Application Readiness", "Last Seen Date", "Pivot_Devices_List_13747", "Boot Up Date", "Device", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Users", "Compliance", "App Count (Entitled)", "Domain", "Pivot_Users_List_13747", "Description", "User", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Mailboxes", "Alias", "Owner City", "Created Date", "Pivot_Mailboxes_List_13747", "Display Name", "Mailbox", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Applications", "Application", "Evergreen Capacity Unit", "Vendor", "Pivot_Applications_List_13747", "Application Key", "Application", new string[0])]
