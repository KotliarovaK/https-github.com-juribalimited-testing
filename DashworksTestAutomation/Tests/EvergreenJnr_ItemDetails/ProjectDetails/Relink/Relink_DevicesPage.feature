...
Scenario: EvergreenJnr_DevicesList_CheckThatRelinkOptionIsWorkedCorrectlyForProjectDetailsOnDevicesPage
	...
	When User switches to the "Windows 10 Updates - Migration" project in the Top bar on Item details page
	...
	When User enters '51V5LKK1OI509X' in the 'Device' autocomplete field and selects '51V5LKK1OI509X' value
	...
	And Details page for "51V5LKK1OI509X" item is displayed to the user
