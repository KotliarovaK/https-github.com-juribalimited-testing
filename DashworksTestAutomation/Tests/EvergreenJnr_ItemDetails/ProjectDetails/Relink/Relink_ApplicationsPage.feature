...
@Evergreen @Applications @EvergreenJnr_ItemDetails @Relink @DAS18002 @DAS18112 @DAS17899 @Not_Ready
Scenario: EvergreenJnr_ApplicationsList_CheckThatRelinkOptionIsWorkedCorrectlyForProjectDetailsOnApplicationsPage
	...
	When User enters '002' in the 'Application' autocomplete field and selects 'Altera Quartus II Programmer 4.0 4.0' value
	...
	Then Details page for "Altera Quartus II Programmer 4.0 4.0" item is displayed to the user
	Then following content is displayed on the Details Page
	| Title     | Value                                   |
	| Name      | ActiveCGM Browser Netscape Plugin V6P07 |
	| App Owner |                                         |
	...
	Then following content is displayed on the Details Page
	| Title     | Value                                |
	| Name      | Altera Quartus II Programmer 4.0 4.0 |
	| App Owner |                                      |