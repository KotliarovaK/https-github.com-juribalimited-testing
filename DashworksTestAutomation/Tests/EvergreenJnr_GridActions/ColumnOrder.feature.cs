    ...
    public partial class ColumnOrderFeature
    {
        ...
        public virtual void EvergreenJnr_AllLists_CheckThatSaveButtonIsNotDisplayedIfTheGridColumnsWasRemovedAndReturnedToDefaultPosition(string pageName, string columnName, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EvergreenJnr_AllLists_CheckThatSaveButtonIsNotDisplayedIfTheGridColumnsWasRemoved" +
                    "AndReturnedToDefaultPosition", @__tags);
            this.ScenarioSetup(scenarioInfo);
            this.FeatureBackground();
            testRunner.When(string.Format("User clicks \"{0}\" on the left-hand menu", pageName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then(string.Format("\"{0}\" list should be displayed to the user", pageName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
        ...
        public virtual void EvergreenJnr_DevicesList_ChecksThatSubcategoriesOnFiltersPanelAreDisplayedInAlphabeticalOrder()
        {
            ...
            table21.AddRow(new string[] {
                        "Compliance"});
            testRunner.Then("the following subcategories are displayed for Selected Columns category:", ((string)(null)), table21, "Then ");
            ...
            table22.AddRow(new string[] {
                        "Compliance"});
            testRunner.And("Column is displayed in following order:", ((string)(null)), table22, "And ");
            testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("Filters panel is displayed to the user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
        ...
        public virtual void EvergreenJnr_ApplicationsList_ChecksThatSubcategoriesOnColumnsPanelAreDisplayedInAlphabeticalOrderAfterAddingFilters()
        {
            ...
            table24.AddRow(new string[] {
                        "Inventory Site"});
            testRunner.And("Column is displayed in following order:", ((string)(null)), table24, "And ");
            testRunner.When("User clicks Add New button on the Filter panel", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("the subcategories are displayed for open category in alphabetical order", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.When("User clicks the Columns button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("Columns panel is displayed to the user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
        ...
        public virtual void EvergreenJnr_UsersList_ChecksThatSubcategoriesOnColumnsPanelAreDisplayedInAlphabeticalOrderAfterAddingDepartmentFilters()
        {
            ...
            table26.AddRow(new string[] {
                        "Department Name"});
            testRunner.Then("the following subcategories are displayed for Selected Columns category:", ((string)(null)), table26, "Then ");
            testRunner.Then("User closed \"Selected Columns\" columns category", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            testRunner.Then("the following subcategories are displayed for Selected Columns category:", ((string)(null)), table27, "Then ");
            testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("Filters panel is displayed to the user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.When("User clicks Add New button on the Filter panel", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("the subcategories are displayed for open category in alphabetical order", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table28.AddRow(new string[] {
                        "Department Full Path"});
            testRunner.When("User removes ColumnName column by Column panel", ((string)(null)), table28, "When ");
            ...
            table29.AddRow(new string[] {
                        "Department Name"});
            testRunner.Then("the following subcategories are displayed for open category:", ((string)(null)), table29, "Then ");
            testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("Filters panel is displayed to the user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table30.AddRow(new string[] {
                        "Department Name"});
            testRunner.Then("the following subcategories are displayed for open category:", ((string)(null)), table30, "Then ");
            this.ScenarioCleanup();
        }
    }
}
