...
Examples:
	...
	| Application                                     | evergreen/#/devices?$filter=(application%20NOT%20EQUALS%20('882'%2C'839'%2C'778')%20WHERE%20(netdo%2Cnubdo%2Cnetd%2Cnuod%2Cniod))                                                                                     | 17,225 |
	| Application                                     | evergreen/#/devices?$filter=(application%20EQUALS%20('882')%20WHERE%20(nuod))                                                                                                                                         | 17,225 |
	| Application Compliance                          | evergreen/#/devices?$filter=(applicationMigrationRAG%20EQUALS%20('Red')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                                               | 17,225 |
	...
	| General information field 5 (App Custom Fields) | evergreen/#/devices?$filter=(applicationCustomField_79%20DOES%20NOT%20BEGIN%20WITH%20('General%205')%20WHERE%20(nubdo%2Cniod))&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,deviceOwnerCustomField_79 | 17,225 |
...
Examples: 
	...
	| Application Import                                                                                      | evergreen/#/devices?$filter=(applicationImport%20EQUALS%20('SCCM%202012%20PS1')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                                              | 17,225 | Application whose Import is SCCM 2012 PS1 not entitled to device's owner; not used by device's owner; not installed on device; not entitled to device; or not used on device                                                                      |
