...
Examples:
	| FilterName                                      | QueryString                                                                                                                                                                                                           | Rows   |
	| App Count (Entitled)                            | evergreen/#/devices?$filter=(entitledApplications%20%3C%3E%2012)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,entitledApplications&$orderby=entitledApplications%20desc                               | 17,223 |
	...
	| App Count (Used)                                | evergreen/#/devices?$filter=(usedApplications%20%3C%2011)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,installedApplications,usedApplications                                                         | 17,186 |
	| Application                                     | evergreen/#/devices?$filter=(application%20NOT%20EQUALS%20('882'%2C'839'%2C'778')%20WHERE%20(netdo%2Cnubdo%2Cnetd%2Cnuod%2Cniod))                                                                                     | 17,285 |
	| Application                                     | evergreen/#/devices?$filter=(application%20EQUALS%20('882')%20WHERE%20(nuod))                                                                                                                                         | 17,285 |
	| Application Compliance                          | evergreen/#/devices?$filter=(applicationMigrationRAG%20EQUALS%20('Red')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                                               | 17,285 |
	...
	| Application Name                                | evergreen/#/devices?$filter=(applicationName%20NOT%20EQUALS%20('%25SQL_PRODUCT_SHORT_NAME%25%20Data%20Tools%20-%20BI%20for%20Visual%20Studio%202013')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                 | 17,285 |
	| Application Name                                | evergreen/#/devices?$filter=(applicationName%20CONTAINS%20('7zip')%20WHERE%20(nuod))                                                                                                                                  | 17,285 |
	| Application Name                                | evergreen/#/devices?$filter=(applicationName%20BEGINS%20WITH%20('7zip')%20WHERE%20(ubdo%2Cetd))                                                                                                                       | 11     |
	| Application Name                                | evergreen/#/devices?$filter=(applicationName%20DOES%20NOT%20BEGIN%20WITH%20('7zip')%20WHERE%20(nubdo%2Cnetdo))                                                                                                        | 17,156 |
	...
	| Application Owner (App Custom Fields)           | evergreen/#/devices?$filter=(applicationCustomField_80%20NOT%20EQUALS%20('App%20Discovery')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                           | 17,285 |
	...
	| General information field 5 (App Custom Fields) | evergreen/#/devices?$filter=(applicationCustomField_79%20DOES%20NOT%20BEGIN%20WITH%20('General%205')%20WHERE%20(nubdo%2Cniod))&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,deviceOwnerCustomField_79 | 17,285 |
	| General information field 5 (App Custom Fields) | evergreen/#/devices?$filter=(applicationCustomField_79%20ENDS%20WITH%20('0.5')%20WHERE%20(nubdo%2Cnetdo%2Cnuod%2Cnetd%2Cniod))&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,deviceOwnerCustomField_79 | 17,285 |
	#| Application Name                                | evergreen/#/devices?$filter=(applicationName%20DOES%20NOT%20END%20WITH%20('1.1')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))                                                                                           | 17,224 |
	#| Application Import                              | evergreen/#/devices?$filter=(applicationImport%20NOT%20EQUALS%20('SCCM%202012%20PS1'%2C'A01%20SMS%20(Spoof%C2%A7'%2C'DC1%20SMS%20(DEV50%C2%A7'%2C'SCCM%202012'%2C'SCCM%202012%20Named%20Instance')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo)) | 5,607    |
...
Examples:
	...
	| App Count (Used)                                | evergreen/#/devices?$filter=(usedApplications%20%3C%3D%20100)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,usedApplications&$orderby=usedApplications%20desc                                                 | 17,285 | App Count (Used) is less than or equal to 100                                                                                                                                                                                                     |
	...
	| Application Compliance                          | evergreen/#/devices?$filter=(applicationMigrationRAG%20NOT%20EQUALS%20('Red'%2C'Amber'%2C'Green'%2C'Not%20Applicable')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))                                                            | 4,547  | Application whose Compliance is not Red, Amber, Green or Not Applicable used on device; entitled to device; installed on device; used by device's owner; or entitled to device's owner                                                            |
	| Application Import                              | evergreen/#/devices?$filter=(applicationImport%20EQUALS%20('SCCM%202012%20PS1')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                                              | 17,285 | Application whose Import is SCCM 2012 PS1 not entitled to device's owner; not used by device's owner; not installed on device; not entitled to device; or not used on device                                                                      |
	| Application Name                                | evergreen/#/devices?$filter=(applicationName%20ENDS%20WITH%20('1.1')%20WHERE%20(nubdo%2Cnetdo%2Cnuod%2Cnetd%2Cniod))                                                                                                         | 17,285 | Application whose Name ends with 1.1 not used by device's owner; not entitled to device's owner; not used on device; not entitled to device; or not installed on device                                                                           |
	| Application Owner (App Custom Fields)           | evergreen/#/devices?$filter=(applicationCustomField_80%20CONTAINS%20('app')%20WHERE%20(nuod))                                                                                                                                | 17,285 | Application Owner contains app not used on device                                                                                                                                                                                                 |
...
Examples:
	...
	| Application Key        | evergreen/#/users?$filter=(applicationKey%20>%201%20WHERE%20(netdobu))                                                                 | 26,803 | Application whose Key is greater than 1 not entitled to any device owned by user                                                                                                                                        |
	| Application Key        | evergreen/#/users?$filter=(applicationKey%20<%202%20WHERE%20(ubu%2Cuodou))                                                             | 191    | Application whose Key is less than 2 used by user; or used on a device owned by user                                                                                                                                    |
