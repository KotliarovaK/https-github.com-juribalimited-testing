...
Examples:
	...
	| App Count (Used)                                | evergreen/#/devices?$filter=(usedApplications%20%3C%2011)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,installedApplications,usedApplications                                                         | 17,126 |
	...
	| Application Owner (App Custom Fields)           | evergreen/#/devices?$filter=(applicationCustomField_80%20NOT%20EQUALS%20('App%20Discovery')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))                                                                           | 17,225 |
...
Examples: 
	...
	| Application Name                                                                                        | evergreen/#/devices?$filter=(applicationName%20ENDS%20WITH%20('1.1')%20WHERE%20(nubdo%2Cnetdo%2Cnuod%2Cnetd%2Cniod))                                                                                                         | 17,225 | Application whose Name ends with 1.1 not used by device's owner; not entitled to device's owner; not used on device; not entitled to device; or not installed on device                                                                           |
	| Application Owner (App Custom Fields)                                                                   | evergreen/#/devices?$filter=(applicationCustomField_80%20CONTAINS%20('app')%20WHERE%20(nuod))                                                                                                                                | 17,225 | Application Owner contains app not used on device                                                                                                                                                                                                 |
