...
Examples: 
	...
	| Application Compliance                                                                                  | evergreen/#/devices?$filter=(applicationMigrationRAG%20NOT%20EQUALS%20('Red'%2C'Amber'%2C'Green'%2C'Not%20Applicable')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))                                                            | 63     | Application whose Compliance is not Red, Amber, Green or Not Applicable used on device; entitled to device; installed on device; used by device's owner; or entitled to device's owner                                                            |
