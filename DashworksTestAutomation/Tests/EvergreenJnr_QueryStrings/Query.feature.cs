...
namespace DashworksTestAutomation.Tests.EvergreenJnr_QueryStrings
{
    ...
    public partial class QueryFeature
    {
        ...
        [NUnit.Framework.CategoryAttribute("EvergreenJnr_QueryStrings")]
        [NUnit.Framework.CategoryAttribute("DAS13179")]
        public virtual void EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheck()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheck", new string[] {
                        "Evergreen",
                        "Devices",
                        "EvergreenJnr_QueryStrings",
                        "DAS13179"});
