...
namespace DashworksTestAutomation.Tests.EvergreenJnr_QueryStrings
{
    ...
    public partial class QueryFeature
    {
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("EvergreenJnr_QueryString_AdvancedFilterRowCountCheck")]
        [NUnit.Framework.CategoryAttribute("Evergreen")]
        [NUnit.Framework.CategoryAttribute("Devices")]
        [NUnit.Framework.CategoryAttribute("EvergreenJnr_QueryStrings")]
        [NUnit.Framework.CategoryAttribute("DAS13179")]
        public virtual void EvergreenJnr_QueryString_AdvancedFilterRowCountCheck()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EvergreenJnr_QueryString_AdvancedFilterRowCountCheck", new string[] {
                        "Evergreen",
                        "Devices",
                        "EvergreenJnr_QueryStrings",
                        "DAS13179"});
            ...
            table10.AddRow(new string[] {
                        "App Count (Entitled)",
                        "evergreen/#/devices?$filter=(entitledApplications%20%3C%3E%2012)&$select=hostname" +
                            ",chassisCategory,oSCategory,ownerDisplayName,entitledApplications&$orderby=entit" +
                            "ledApplications%20desc",
                        "17,163"});
            table10.AddRow(new string[] {
                        "App Count (Installed)",
                        "evergreen/#/devices?$filter=(installedApplications%20%3E%2012)&$select=hostname,c" +
                            "hassisCategory,oSCategory,ownerDisplayName,installedApplications",
                        "94"});
            table10.AddRow(new string[] {
                        "App Count (Used)",
                        "evergreen/#/devices?$filter=(usedApplications%20%3C%2011)&$select=hostname,chassi" +
                            "sCategory,oSCategory,ownerDisplayName,installedApplications,usedApplications",
                        "17,126"});
            table10.AddRow(new string[] {
                        "Application",
                        "evergreen/#/devices?$filter=(application%20NOT%20EQUALS%20(\'882\'%2C\'839\'%2C\'778\')" +
                            "%20WHERE%20(netdo%2Cnubdo%2Cnetd%2Cnuod%2Cniod))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application",
                        "evergreen/#/devices?$filter=(application%20EQUALS%20(\'882\')%20WHERE%20(nuod))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application Compliance",
                        "evergreen/#/devices?$filter=(applicationMigrationRAG%20EQUALS%20(\'Red\')%20WHERE%2" +
                            "0(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20EQUALS%20(\'%25SQL_PRODUCT_SHORT_NA" +
                            "ME%25%20Data%20Tools%20-%20BI%20for%20Visual%20Studio%202013\')%20WHERE%20(uod%2C" +
                            "etd%2Cubdo%2Ciod%2Cetdo))",
                        "2"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20NOT%20EQUALS%20(\'%25SQL_PRODUCT_SH" +
                            "ORT_NAME%25%20Data%20Tools%20-%20BI%20for%20Visual%20Studio%202013\')%20WHERE%20(" +
                            "netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20CONTAINS%20(\'7zip\')%20WHERE%20(nuo" +
                            "d))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20BEGINS%20WITH%20(\'7zip\')%20WHERE%2" +
                            "0(ubdo%2Cetd))",
                        "11"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20DOES%20NOT%20BEGIN%20WITH%20(\'7zip" +
                            "\')%20WHERE%20(nubdo%2Cnetdo))",
                        "17,066"});
            table10.AddRow(new string[] {
                        "Application Name",
                        "evergreen/#/devices?$filter=(applicationName%20DOES%20NOT%20END%20WITH%20(\'1.1\')%" +
                            "20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))",
                        "17,224"});
            table10.AddRow(new string[] {
                        "Application Vendor",
                        "evergreen/#/devices?$filter=(applicationManufacturer%20EQUALS%20(\'Aaronbock%20Dev" +
                            "elopment\')%20WHERE%20(etdo))",
                        "95"});
            table10.AddRow(new string[] {
                        "Application Vendor",
                        "evergreen/#/devices?$filter=(applicationManufacturer%20NOT%20EQUALS%20(\'Aaronbock" +
                            "%20Development\')%20WHERE%20(netdo))",
                        "12,200"});
            table10.AddRow(new string[] {
                        "Application Owner (App Custom Fields)",
                        "evergreen/#/devices?$filter=(applicationCustomField_80%20EQUALS%20(\'App%20Discove" +
                            "ry\')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))",
                        "1,003"});
            table10.AddRow(new string[] {
                        "Application Owner (App Custom Fields)",
                        "evergreen/#/devices?$filter=(applicationCustomField_80%20NOT%20EQUALS%20(\'App%20D" +
                            "iscovery\')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod))",
                        "17,225"});
            table10.AddRow(new string[] {
                        "Application Owner (App Custom Fields)",
                        "evergreen/#/devices?$filter=(applicationCustomField_80%20NOT%20EQUALS%20(\'App%20D" +
                            "iscovery\')%20WHERE%20(iod))",
                        "12,076"});
            table10.AddRow(new string[] {
                        "General information field 5 (App Custom Fields)",
                        "evergreen/#/devices?$filter=(applicationCustomField_79%20DOES%20NOT%20BEGIN%20WIT" +
                            "H%20(\'General%205\')%20WHERE%20(nubdo%2Cniod))&$select=hostname,chassisCategory,o" +
                            "SCategory,ownerDisplayName,deviceOwnerCustomField_79",
                        "17,225"});
            table10.AddRow(new string[] {
                        "General information field 5 (App Custom Fields)",
                        "evergreen/#/devices?$filter=(applicationCustomField_79%20ENDS%20WITH%20(\'0.5\')%20" +
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheck")]
        [NUnit.Framework.CategoryAttribute("Evergreen")]
        [NUnit.Framework.CategoryAttribute("Devices")]
        [NUnit.Framework.CategoryAttribute("EvergreenJnr_QueryStrings")]
        [NUnit.Framework.CategoryAttribute("DAS13179")]
        ...
        public virtual void EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheck(string filterName, string queryString, string rows, string filterInfo, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheck", @__tags);
            this.ScenarioSetup(scenarioInfo);
            this.FeatureBackground();
