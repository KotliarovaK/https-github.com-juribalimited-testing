...
namespace DashworksTestAutomation.Tests.EvergreenJnr_ListDetails
{
    ...
    public partial class ListDetailsFunctionalityFeature
    {
        ...
        [NUnit.Framework.CategoryAttribute("Delete_Newly_Created_List")]
        [NUnit.Framework.TestCaseAttribute("Devices", "Devices DAS11498", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Users", "Users DAS11498", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Applications", "Applications DAS11498", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Mailboxes", "Mailboxes DAS11498", new string[0])]
        ...
        [NUnit.Framework.TestCaseAttribute("Applications", "microsoft server", "Applications Static List DAS-12967", "UserSchedu: Readiness ID", "29", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Users", "Peterson", "Users Static List DAS-12967", "Compliance", "28", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Devices", "aba", "Devices Static List DAS-12967", "BIOS Name", "19", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Mailboxes", "ab1", "Mailboxes Static List DAS-12967", "Alias", "14", new string[0])]
