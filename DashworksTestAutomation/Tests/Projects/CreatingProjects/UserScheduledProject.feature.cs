    ...
    public partial class CreateUserScheduledProjectFeature
    {
        ...
        public virtual void Projects_CreateUserScheduledProject()
        {
            ...
            table49.AddRow(new string[] {
                        ...
                        "true",
                        "80"});
            testRunner.When("User updates the Details on Capacity tab", ((string)(null)), table49, "When ");
            testRunner.Then("Success message is displayed with \"Details successfully updated.\" text", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table50.AddRow(new string[] {
                        ...
                        "100",
                        "100"});
            testRunner.And("User updates the Capacity page on Capacity tab for \"1\" Team", ((string)(null)), table50, "And ");
            ...
            table51.AddRow(new string[] {
                        ...
                        "10",
                        "10"});
            testRunner.When("User updates the Capacity page on Capacity tab for \"2\" Team", ((string)(null)), table51, "When ");
            testRunner.Then("Success message is displayed with \"Capacity information successfully updated.\" te" +
                    "xt", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table52.AddRow(new string[] {
                        ...
                        "100",
                        "100"});
            testRunner.When("User updates the Capacity page on Capacity tab for \"3\" Team", ((string)(null)), table52, "When ");
            testRunner.Then("Success message is displayed with \"Capacity information successfully updated.\" te" +
                    "xt", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            ...
            table53.AddRow(new string[] {
                        ...
                        "0",
                        "UserScheduledProject"});
            testRunner.And("User updates the Override Dates on Capacity tab", ((string)(null)), table53, "And ");
