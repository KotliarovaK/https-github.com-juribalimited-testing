...
Scenario: Projects_CreateUserScheduledProject
	...
	| AAA0UserScheduledProject | UserScheduledProject 0 | 1234qwer | 1234qwer        | Dashworks Evergreen User |
	And Success message is displayed
	And created User is displayed in the table
	And User create a new Dashworks User
	| Username                 | FullName               | Password | ConfirmPassword | RolesString              |
	| AAA1UserScheduledProject | UserScheduledProject 1 | 1234qwer | 1234qwer        | Dashworks Evergreen User |
	And Success message is displayed
	And created User is displayed in the table
	And User create a new Dashworks User
	| Username                 | FullName               | Password | ConfirmPassword | RolesString              |
	| AAA2UserScheduledProject | UserScheduledProject 2 | 1234qwer | 1234qwer        | Dashworks Evergreen User |
	And Success message is displayed
	And created User is displayed in the table
