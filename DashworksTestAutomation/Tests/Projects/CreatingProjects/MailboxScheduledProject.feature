...
Scenario: Projects_CreateMailboxScheduledProject
	...
	| AAA0MailboxScheduledProject | MailboxScheduledProject 0 | 1234qwer | 1234qwer        | DashworksEvergreenUsers |
	And Success message is displayed
	And created User is displayed in the table
	And User create a new Dashworks User
	| Username                    | FullName                  | Password | ConfirmPassword | RolesString             |
	| AAA1MailboxScheduledProject | MailboxScheduledProject 1 | 1234qwer | 1234qwer        | DashworksEvergreenUsers |
	And Success message is displayed
	And created User is displayed in the table
	And User create a new Dashworks User
	| Username                    | FullName                  | Password | ConfirmPassword | RolesString             |
	| AAA2MailboxScheduledProject | MailboxScheduledProject 2 | 1234qwer | 1234qwer        | DashworksEvergreenUsers |
	And Success message is displayed
	And created User is displayed in the table
