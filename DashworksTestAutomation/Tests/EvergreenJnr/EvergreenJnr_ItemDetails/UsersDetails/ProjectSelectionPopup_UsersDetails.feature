Feature: ProjectSelectionPopup_UsersDetails
...
@Evergreen @Users @EvergreenJnr_ItemDetails @ItemDetailsDisplay @DAS19704 @Wormhole
Scenario: EvergreenJnr_UsersList_CheckThatProjectSelectionPopupForUsersDetailsPageIsWorkingCorrectly
	When User navigates to the 'User' details page for '003F5D8E1A844B1FAA5' item
	Then Details page for '003F5D8E1A844B1FAA5' item is displayed to the user
	...
	Then 'USE ME FOR AUTOMATION(USR SCHDLD)' content is displayed in 'Item Details Project' dropdown
	Then 'Project Details' left submenu item is active

#AnnI 3/24/20: This functionality is implemented only for 'Wormhole'
@Evergreen @Users @EvergreenJnr_ItemDetails @ProjectsTab @DAS20432 @DAS19704 @Wormhole
Scenario: EvergreenJnr_UsersList_CheckThatTabRedirectionIsWorkedCorrectlyAfterSwitchingFromProjectsToEvergreenModes
	When User navigates to the 'User' details page for '003F5D8E1A844B1FAA5' item
	Then Details page for '003F5D8E1A844B1FAA5' item is displayed to the user
