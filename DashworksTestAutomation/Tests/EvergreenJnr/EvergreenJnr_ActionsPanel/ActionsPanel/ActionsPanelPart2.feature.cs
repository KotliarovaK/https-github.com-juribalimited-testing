...
#line hidden
            ...
            table2.AddRow(new string[] {
                        string.Format("{0}", rowName)});
#line 22
 testRunner.When(string.Format("User select \"{0}\" rows in the grid", columnHeader), ((string)(null)), table2, "When ");
#line hidden
            ...
            table3.AddRow(new string[] {
                        "Bulk update"});
#line 25
 testRunner.Then("following Values are displayed in the \'Action\' dropdown:", ((string)(null)), table3, "Then ");
#line hidden
...
#line 103
 testRunner.Then("\'Project or Evergreen\' autocomplete contains following options:", ((string)(null)), table8, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
