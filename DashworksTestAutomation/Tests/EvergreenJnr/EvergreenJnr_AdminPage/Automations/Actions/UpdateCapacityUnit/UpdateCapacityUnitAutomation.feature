...
#Scenario: EvergreenJnr_AdminPage_CheckEditActionPageForUpdateRingUpdateBucket
#	When User creates new Automation via API and open it
#	| AutomationName        | Description | Active | StopOnFailedAction | Scope     | Run    |
...
#Scenario: EvergreenJnr_AdminPage_CheckAutomationLogUpdateRingForEvergreenAllLinkedDevicesAndAllLinkedMailboxesUpdateBucket
...
#
#@Evergreen @EvergreenJnr_AdminPage @Automations @DAS19083 @Cleanup @Wormhole
#Scenario: EvergreenJnr_AdminPage_CheckAutomationLogUpdateRingForProjectsUpdateBucket
#	#Create list
...
#
#@Evergreen @EvergreenJnr_AdminPage @Automations @DAS19083 @Cleanup @Wormhole
#Scenario: EvergreenJnr_AdminPage_CheckAutomationLogUpdateRingForDeletedRingUpdateBucket
#	#Create list
#	When User clicks 'Devices' on the left-hand menu
#	Then 'All Devices' list should be displayed to the user
#	When User clicks the Actions button
...
#
#@Evergreen @EvergreenJnr_AdminPage @Automations @DAS19083 @Cleanup @Wormhole
#Scenario: EvergreenJnr_AdminPage_CheckAutomationLogUpdateRingForDeletedProjectUpdateBucket
#	#Create list
#	When User clicks 'Devices' on the left-hand menu
#	Then 'All Devices' list should be displayed to the user
#	When User clicks the Actions button
