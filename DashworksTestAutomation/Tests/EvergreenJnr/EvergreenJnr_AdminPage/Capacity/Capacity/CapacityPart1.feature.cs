...
#line 23
 testRunner.And("grid headers are displayed in the following order", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            ...
            table2.AddRow(new string[] {
                        "Applications"});
#line 24
 testRunner.Then("column order", ((string)(null)), table2, "Then ");
#line hidden
