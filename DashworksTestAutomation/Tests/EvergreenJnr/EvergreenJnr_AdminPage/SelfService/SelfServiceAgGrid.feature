...
Scenario: EvergreenJnr_AdminPage_CheckThatSelfServiceCogMenuDisplaysProperly
	...
	When User clicks 'Admin' on the left-hand menu
	When User navigates to the 'Self Services' left menu item
	When User clicks Cog-menu for 'TestSelfServiceCogMenu_name1' item in the 'Self Service Name' column
	Then User sees following cog-menu items on Admin page:
	| items            |
	| Edit             |
	| Enable           | 
	| Delete           |
	When User clicks Cog-menu for 'TestSelfServiceCogMenu_name5' item in the 'Self Service Name' column
	Then User sees following cog-menu items on Admin page:
	| items            |
	| Edit             |
	| Disable          | 
