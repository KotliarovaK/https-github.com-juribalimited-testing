...
namespace DashworksTestAutomation.Tests.EvergreenJnr_FiltersFeature
{
    ...
    public partial class RemoveFilterFeature
    {
        ...
        public virtual void EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCount("EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCount")
        {
            ...
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCountInternal("EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCount");
                    return;
                }
        ...
        private void EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCountInternal("EvergreenJnr_DevicesList_CheckThatResetIsUpdatingRowCount")
        {
        ...
        public virtual void EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCount("EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCount")
        {
            System.Exception lastException = null;
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCountInternal("EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCount");
                    return;
                }
                catch (System.Exception exc)
                {
        ...
        private void EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCountInternal("EvergreenJnr_DevicesList_CheckThatDeleteByUrlIsUpdatingRowCount")
        {
        ...
        public virtual void EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCount("EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCount")
        {
            System.Exception lastException = null;
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCountInternal("EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCount");
                    return;
                }
                catch (System.Exception exc)
                {
        ...
        private void EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCountInternal("EvergreenJnr_UsersList_CheckThatDeletePartOfFilterFromUrlIsUpdatingRowCount")
        {
        ...
        public virtual void EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadList("EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadList")
        {
            System.Exception lastException = null;
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadListInternal("EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadList");
                    return;
                }
                catch (System.Exception exc)
                {
        ...
        private void EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadListInternal("EvergreenJnr_AllLists_CheckThatCancelingUnsavedFilterDoesNotReloadList")
        {
