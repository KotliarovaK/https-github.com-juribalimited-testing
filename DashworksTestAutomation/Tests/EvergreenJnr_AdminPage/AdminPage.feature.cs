...
namespace DashworksTestAutomation.Tests.EvergreenJnr_AdminPage
{
    ...
    public partial class AdminPageFeature
    {
        ...
        [NUnit.Framework.TestCaseAttribute("Projects", "EmailMigra", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Teams", "IB Team", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Buckets", "Evergreen", new string[0])]
        [NUnit.Framework.TestCaseAttribute("Capacity Units", "True", new string[0])]
        public virtual void EvergreenJnr_AdminPage_CheckPositionOfContextMenuInGrid(string pageName, string cellText, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("EvergreenJnr_AdminPage_CheckPositionOfContextMenuInGrid", @__tags);
            this.ScenarioSetup(scenarioInfo);
            this.FeatureBackground();
            testRunner.When("User clicks Admin on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
        ...
        public virtual void EvergreenJnr_AdminPage_CheckTheBucketStateForOnboardedObjects()
        {
            ...
            testRunner.And("User selects \"Clone evergreen buckets to project buckets\" in the Mode Project dro" +
