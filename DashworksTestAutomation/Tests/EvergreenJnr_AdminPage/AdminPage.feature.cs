...
namespace DashworksTestAutomation.Tests.EvergreenJnr_AdminPage
{
    ...
    public partial class AdminPageFeature
    {
        ...
        private void EvergreenJnr_AdminPage_CheckThatNoConsoleErrorsAreDisplayedWhenDeleteDataFromFilterTextFieldForBucketsInternal()
        {
            ...
            testRunner.Then("Counter shows \"558\" found rows", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
        ...
        private void EvergreenJnr_AdminPage_OnboardingMailboxesUsersApplicationsObjectsUsingUpdateAllChangesButtonInternal()
        {
            ...
            testRunner.And("User selects following Objects", ((string)(null)), table69, "And ");
            testRunner.When("User clicks \"Users\" tab in the Project Scope Changes section", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("\"Users to add (0 of 14747 selected)\" is displayed to the user in the Project Scop" +
                    "e Changes section", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.When("User expands the object to add", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
        ...
        private void EvergreenJnr_AdminPage_AddingMembersToTheTeamInternal()
        {
            ...
            table75.AddRow(new string[] {
                        "eugene"});
            testRunner.And("User adds following Objects from list", ((string)(null)), table75, "And ");
            ...
            testRunner.Then("Counter shows \"1\" found rows", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.When("User selects all rows on the grid", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.And("User removes selected members", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
        ...
        private void EvergreenJnr_AdminPage_AddingBucketsToTheTeamInternal()
        {
            ...
            table76.AddRow(new string[] {
                        "Frankfurt"});
            testRunner.And("User adds following Objects from list", ((string)(null)), table76, "And ");
            ...
            testRunner.When("User clicks \"Email Migration\" checkbox from String Filter on the Projects page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.Then("Counter shows \"2\" found rows", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.When("User clicks Reset Filters button on the Admin page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
        ...
        private void EvergreenJnr_AdminPage_AddingAndDeletingPermissionsForMailboxProjectInternal()
        {
            ...
            table78.AddRow(new string[] {
                        "ChangeOwner"});
            testRunner.And("User selects following Mailbox permissions", ((string)(null)), table78, "And ");
            ...
            table79.AddRow(new string[] {
                        "AvailabilityOnly"});
            testRunner.And("User selects following Mailbox folder permissions", ((string)(null)), table79, "And ");
            ...
            table80.AddRow(new string[] {
                        "AvailabilityOnly"});
            testRunner.Then("following Mailbox permissions are displayed to the user", ((string)(null)), table80, "Then ");
            ...
            table81.AddRow(new string[] {
                        "AvailabilityOnly"});
            testRunner.Then("following Mailbox permissions are displayed to the user", ((string)(null)), table81, "Then ");
            ...
            table82.AddRow(new string[] {
                        "Delegated mailboxes"});
            testRunner.And("following checkboxes are checked in the Scope section", ((string)(null)), table82, "And ");
            testRunner.When("User selects \"Scope Changes\" tab on the Project details page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.And("User clicks \"Users\" tab in the Project Scope Changes section", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            ...
            table83.AddRow(new string[] {
                        "Author"});
            testRunner.And("User removes following Mailbox permissions", ((string)(null)), table83, "And ");
            testRunner.And("User selects \"Scope Changes\" tab on the Project details page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            testRunner.And("User selects \"Scope Details\" tab on the Project details page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            testRunner.And("User navigates to the \"User Scope\" tab in the Scope section on the Project detail" +
                    "s page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
        ...
        private void EvergreenJnr_AdminPage_CreatingDefaultBucketInternal()
        {
            ...
            testRunner.Then("Success message The \"Unassigned\" bucket has been updated is displayed on the Buck" +
                    "ets page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.And("Delete \"TestBucket5\" Bucket in the Administration", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            this.ScenarioCleanup();
        }
    }
}
