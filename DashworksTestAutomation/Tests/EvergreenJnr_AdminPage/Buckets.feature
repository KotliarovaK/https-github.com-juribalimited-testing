...
@Evergreen @Admin @EvergreenJnr_AdminPage @AdminPage @DAS12170 @DAS13011 @Remove_Added_Objects_From_Buckets @Buckets
...
@Evergreen @Admin @EvergreenJnr_AdminPage @AdminPage @DAS12999 @DAS13420 @Buckets @Delete_Newly_Created_Bucket @Buckets
...
@Evergreen @Admin @EvergreenJnr_AdminPage @AdminPage @DAS12905 @Buckets @Delete_Newly_Created_Bucket @Delete_Newly_Created_Project
Scenario: EvergreenJnr_AdminPage_ChecksThatAddedObjectsThatWasUsedRemovedBucketAreDisplayedCorrectlyInProjectHistory 
	...
	When User enters "1Bucket12905" text in the Search field for "Bucket" column
	Then "2" content is displayed in "Devices" column
	When User enters "2Bucket12905" text in the Search field for "Bucket" column
	Then "2" content is displayed in "Devices" column
	When User enters "Unassigned" text in the Search field for "Bucket" column
	Then "2" content is displayed in "Devices" column
	...
	When User enters "001PSUMZYOW581" text in the Search field for "Item" column
	Then "Deleted bucket" italic content is displayed in "Bucket" column

@Evergreen @Admin @EvergreenJnr_AdminPage @AdminPage @DAS12930 @Buckets @Delete_Newly_Created_Bucket @Delete_Newly_Created_Project
Scenario: EvergreenJnr_AdminPage_
	When User clicks Admin on the left-hand menu
	Then Admin page should be displayed to the user
	When User clicks "Buckets" link on the Admin page
	Then "Buckets" page should be displayed to the user
	When User clicks the "CREATE BUCKET" Action button
	Then "Create Bucket" page should be displayed to the user
	When User enters "1Bucket12930" in the Bucket Name field
	And User selects "K-Team" team in the Team dropdown on the Buckets page
	And User clicks Create button on the Create Bucket page
	Then Success message is displayed and contains "The bucket has been created" text
	When User clicks the "CREATE BUCKET" Action button
	Then "Create Bucket" page should be displayed to the user
	When User enters "2Bucket12930" in the Bucket Name field
	And User selects "K-Team" team in the Team dropdown on the Buckets page
	And User clicks Create button on the Create Bucket page
	Then Success message is displayed and contains "The bucket has been created" text
	When User clicks "Projects" link on the Admin page
