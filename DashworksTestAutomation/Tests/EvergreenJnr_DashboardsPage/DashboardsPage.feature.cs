    ...
    public partial class DashboardsPageFeature
    {
        ...
        public virtual void EvergreenJnr_DashboardsPage_CheckThatErrorIsNotOccursWhenCreatingWidgetThatUsesCpuArchitField()
        {
            ...
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.EvergreenJnr_DashboardsPage_CheckThatErrorIsNotOccursWhenCreatingWidgetThatUsesCpuArchitFieldInternal();
                    return;
                }
                catch (System.Exception exc)
                {
        ...
        private void EvergreenJnr_DashboardsPage_CheckThatErrorIsNotOccursWhenCreatingWidgetThatUsesCpuArchitFieldInternal()
        {
