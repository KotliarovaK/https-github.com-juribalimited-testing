    ...
    public partial class DashboardsPageFeature
    {
        ...
        private void EvergreenJnr_DashboardsPage_CheckThatWidgetStaysOnTopPositionAfterEditingInternal()
        {
            ...
            table24.AddRow(new string[] {
                        ...
                        "",
                        ""});
            testRunner.And("User updates Widget with following info:", ((string)(null)), table24, "And ");
            ...
            table25.AddRow(new string[] {
                        "WidgetForDAS14583_2"});
            testRunner.Then("User sees following Widgets on Dashboards page:", ((string)(null)), table25, "Then ");
        ...
        private void EvergreenJnr_DashboardsPage_CheckThatOwnerCanBeAddedToSharedUsersAsSpecificUserWithDifferentPermissionsInternal()
        {
            ...
            table24.AddRow(new string[] {
                        "Administrator",
                        "Admin"});
            testRunner.And("User adds user to list of shared person", ((string)(null)), table24, "And ");
