...
namespace DashworksTestAutomation.Pages.Evergreen.RightSideActionPanels
{
    class SelfServiceBuilderContextPanel : BaseRightSideActionsPanel
    {
        ...
        {
            var selector = $"{ContextPanelPagePath(contextPanelType, contextPanelName)}/following-sibling::div[contains(@class,'page-level-icon')]/div[contains(@class, 'menu-wrapper')]";
            Driver.WaitForElementToBeDisplayed(By.XPath(selector));
