...
#line hidden
                TechTalk.SpecFlow.Table table3956 = new TechTalk.SpecFlow.Table(new string[] {
                            "ProjectName",
                            "ShortName",
                            "Description",
                            "Type"});
                table3956.AddRow(new string[] {
                            "ProjectForDAS14322",
                            "14322",
                            "",
                            ""});
#line 54
 testRunner.When("User creates new Project on Senior", ((string)(null)), table3956, "When ");
#line hidden
#line 57
...
#line hidden
                TechTalk.SpecFlow.Table table3957 = new TechTalk.SpecFlow.Table(new string[] {
                            "StageName"});
                table3957.AddRow(new string[] {
                            "Stage 14322"});
#line 60
 testRunner.And("User create Stage", ((string)(null)), table3957, "And ");
#line hidden
#line 63
...
#line hidden
                TechTalk.SpecFlow.Table table3958 = new TechTalk.SpecFlow.Table(new string[] {
                            "Name",
                            "Help",
                            "StagesNameString",
                            "TaskTypeString",
                ...
                table3958.AddRow(new string[] {
                            ...
                            "None"});
#line 66
 testRunner.And("User creates Task", ((string)(null)), table3958, "And ");
#line hidden
#line 69
...
#line hidden
                TechTalk.SpecFlow.Table table3959 = new TechTalk.SpecFlow.Table(new string[] {
                            "Name",
                            "TaskStatusString",
                            "DefaultValue"});
                table3959.AddRow(new string[] {
                            "TestValueName",
                            "Open",
                            "false"});
#line 72
 testRunner.When("User create new Value", ((string)(null)), table3959, "When ");
#line hidden
#line 75
...
#line hidden
                TechTalk.SpecFlow.Table table3960 = new TechTalk.SpecFlow.Table(new string[] {
                            "Items"});
                table3960.AddRow(new string[] {
                            "[Select]"});
                table3960.AddRow(new string[] {
                            "User"});
                table3960.AddRow(new string[] {
                ...
                table3960.AddRow(new string[] {
                            "Application"});
#line 101
 testRunner.Then("Next items are displayed as options of Object Type property:", ((string)(null)), table3960, "Then ");
#line hidden
#line 107
 testRunner.When("User selects \"Text\" as Task Value Type", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
                TechTalk.SpecFlow.Table table3961 = new TechTalk.SpecFlow.Table(new string[] {
                            "Items"});
                table3961.AddRow(new string[] {
                            "[Select]"});
                table3961.AddRow(new string[] {
                            "User"});
                table3961.AddRow(new string[] {
                ...
                table3961.AddRow(new string[] {
                            "Application"});
#line 108
 testRunner.Then("Next items are displayed as options of Object Type property:", ((string)(null)), table3961, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
this.FeatureBackground();
#line hidden
                TechTalk.SpecFlow.Table table3962 = new TechTalk.SpecFlow.Table(new string[] {
                            "ProjectName",
                            "Scope",
                            "ProjectTemplate",
                            "Mode"});
                table3962.AddRow(new string[] {
                            "ProjectForTask18247",
                            "All Devices",
                            "None",
                            "Standalone Project"});
#line 117
 testRunner.When("Project created via API and opened", ((string)(null)), table3962, "When ");
#line hidden
#line 120
 testRunner.When("User clicks \'Projects\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 126
 testRunner.When("User clicks \"Create Stage\" button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
                TechTalk.SpecFlow.Table table3963 = new TechTalk.SpecFlow.Table(new string[] {
                            "StageName"});
                table3963.AddRow(new string[] {
                            "Stage18247"});
#line 127
 testRunner.And("User create Stage", ((string)(null)), table3963, "And ");
#line hidden
#line 130
 testRunner.And("User clicks \"Create Stage\" button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                TechTalk.SpecFlow.Table table3964 = new TechTalk.SpecFlow.Table(new string[] {
                            "Name",
                            "Help",
                            "StagesNameString",
                            "TaskTypeString",
                ...
                table3964.AddRow(new string[] {
                            ...
                            ""});
#line 134
 testRunner.And("User creates Task", ((string)(null)), table3964, "And ");
#line hidden
#line 137
 testRunner.Then("Success message is displayed with \"Task successfully created\" text", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
