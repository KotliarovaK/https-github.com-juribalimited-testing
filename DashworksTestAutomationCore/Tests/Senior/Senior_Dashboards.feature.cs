...
#line hidden
                ...
                table3962.AddRow(new string[] {
                            ...
                            ""});
#line 54
 testRunner.When("User creates new Project on Senior", ((string)(null)), table3962, "When ");
#line hidden
#line 57
...
#line hidden
                TechTalk.SpecFlow.Table table3965 = new TechTalk.SpecFlow.Table(new string[] {
                            "Name",
                            "TaskStatusString",
                            "DefaultValue"});
                table3965.AddRow(new string[] {
                            "TestValueName",
                            "Open",
                            "false"});
#line 72
 testRunner.When("User create new Value", ((string)(null)), table3965, "When ");
#line hidden
#line 75
...
#line hidden
                TechTalk.SpecFlow.Table table3966 = new TechTalk.SpecFlow.Table(new string[] {
                            "Items"});
                table3966.AddRow(new string[] {
                            "[Select]"});
                table3966.AddRow(new string[] {
                            "User"});
                table3966.AddRow(new string[] {
                ...
                table3966.AddRow(new string[] {
                            "Application"});
#line 101
 testRunner.Then("Next items are displayed as options of Object Type property:", ((string)(null)), table3966, "Then ");
#line hidden
#line 107
 testRunner.When("User selects \"Text\" as Task Value Type", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
                TechTalk.SpecFlow.Table table3967 = new TechTalk.SpecFlow.Table(new string[] {
                            "Items"});
                table3967.AddRow(new string[] {
                            "[Select]"});
                table3967.AddRow(new string[] {
                            "User"});
                table3967.AddRow(new string[] {
                ...
                table3967.AddRow(new string[] {
                            "Application"});
#line 108
 testRunner.Then("Next items are displayed as options of Object Type property:", ((string)(null)), table3967, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
this.FeatureBackground();
#line hidden
                TechTalk.SpecFlow.Table table3968 = new TechTalk.SpecFlow.Table(new string[] {
                            "ProjectName",
                            "Scope",
                            "ProjectTemplate",
                            "Mode"});
                table3968.AddRow(new string[] {
                            "ProjectForTask18247",
                            "All Devices",
                            "None",
                            "Standalone Project"});
#line 117
 testRunner.When("Project created via API and opened", ((string)(null)), table3968, "When ");
#line hidden
#line 120
 testRunner.When("User clicks \'Projects\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 126
 testRunner.When("User clicks \"Create Stage\" button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
                TechTalk.SpecFlow.Table table3969 = new TechTalk.SpecFlow.Table(new string[] {
                            "StageName"});
                table3969.AddRow(new string[] {
                            "Stage18247"});
#line 127
 testRunner.And("User create Stage", ((string)(null)), table3969, "And ");
#line hidden
#line 130
 testRunner.And("User clicks \"Create Stage\" button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                TechTalk.SpecFlow.Table table3970 = new TechTalk.SpecFlow.Table(new string[] {
                            "Name",
                            "Help",
                            "StagesNameString",
                            "TaskTypeString",
                ...
                table3970.AddRow(new string[] {
                            ...
                            ""});
#line 134
 testRunner.And("User creates Task", ((string)(null)), table3970, "And ");
#line hidden
#line 137
 testRunner.Then("Success message is displayed with \"Task successfully created\" text", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
