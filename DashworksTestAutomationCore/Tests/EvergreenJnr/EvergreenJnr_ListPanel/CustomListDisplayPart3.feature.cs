...
#line 14
 testRunner.When("User add \"Compliance\" filter where type is \"Equals\" without added column and foll" +
                        "owing checkboxes:", ((string)(null)), table3131, "When ");
#line hidden
#line 17
...
#line hidden
                ...
                table3132.AddRow(new string[] {
                            "Compliance"});
#line 28
 testRunner.When("User add following columns using URL to the \"Users\" page:", ((string)(null)), table3132, "When ");
#line hidden
#line 31
 testRunner.Then("Save to New Custom List element is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table3133.AddRow(new string[] {
                            "003F5D8E1A844B1FAA5"});
#line 36
 testRunner.When("User select \"Username\" rows in the grid", ((string)(null)), table3133, "When ");
#line hidden
#line 42
...
#line hidden
                ...
                table3134.AddRow(new string[] {
                            "00K4CEEQ737BA4L"});
#line 64
 testRunner.When("User select \"Hostname\" rows in the grid", ((string)(null)), table3134, "When ");
#line hidden
#line 68
 testRunner.And("User selects \'Create static list\' in the \'Action\' dropdown", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 91
 testRunner.When("User create static list with \"Static List TestName\" name on \"Devices\" page with f" +
                        "ollowing items", ((string)(null)), table3135, "When ");
#line hidden
#line 96
 testRunner.Then("\"Static List TestName\" list is displayed to user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table3136.AddRow(new string[] {
                            "Compliance"});
#line 100
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table3136, "When ");
#line hidden
                ...
                table3137.AddRow(new string[] {
                            "Compliance"});
#line 103
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table3137, "Then ");
#line hidden
#line 106
 testRunner.When("User clicks on \'Owner Display Name\' column header", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table3138.AddRow(new string[] {
                            "00I0COBFWHOF27"});
#line 111
 testRunner.When("User select \"Hostname\" rows in the grid", ((string)(null)), table3138, "When ");
#line hidden
#line 114
...
#line hidden
                ...
                table3139.AddRow(new string[] {
                            "Compliance"});
#line 121
 testRunner.And("ColumnName is added to the list", ((string)(null)), table3139, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
