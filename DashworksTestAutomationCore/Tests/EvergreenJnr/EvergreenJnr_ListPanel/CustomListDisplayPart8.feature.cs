...
#line hidden
                ...
                table3443.AddRow(new string[] {
                            ""});
#line 62
 testRunner.When(string.Format("User create static list with \"{0}\" name on \"{1}\" page with following items", staticListName, listName), ((string)(null)), table3443, "When ");
#line hidden
#line 65
...
#line 93
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table3444, "When ");
#line hidden
                ...
                table3445.AddRow(new string[] {
                            string.Format("{0}", addColumn)});
#line 96
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table3445, "Then ");
#line hidden
#line 99
