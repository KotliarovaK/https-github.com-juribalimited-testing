...
#line 12
 testRunner.When("User create static list with \"StaticFilterList_1\" name on \"Devices\" page with fol" +
                        "lowing items", ((string)(null)), table3392, "When ");
#line hidden
#line 16
...
#line hidden
                ...
                table3393.AddRow(new string[] {
                            "Hostname"});
#line 22
 testRunner.And("User selects the following Row Groups on Pivot:", ((string)(null)), table3393, "And ");
#line hidden
                ...
                table3394.AddRow(new string[] {
                            "Hostname"});
#line 25
 testRunner.And("User selects the following Columns on Pivot:", ((string)(null)), table3394, "And ");
#line hidden
                ...
                table3395.AddRow(new string[] {
                            "Hostname"});
#line 28
 testRunner.And("User selects the following Values on Pivot:", ((string)(null)), table3395, "And ");
#line hidden
#line 31
...
#line hidden
                ...
                table3397.AddRow(new string[] {
                            "Pivot"});
#line 54
 testRunner.And("List filter DDL displays the next options", ((string)(null)), table3397, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 82
 testRunner.When("User add \"Device Owner (Saved List)\" filter where type is \"In list\" with selected" +
                        " Expanded Checkboxes and following Association:", ((string)(null)), table3398, "When ");
#line hidden
#line 85
