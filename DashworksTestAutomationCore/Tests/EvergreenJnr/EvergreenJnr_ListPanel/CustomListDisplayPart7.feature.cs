...
#line hidden
                ...
                table3454.AddRow(new string[] {
                            string.Format("{0}", newColumnName)});
#line 73
 testRunner.And("User adds columns to the list", ((string)(null)), table3454, "And ");
#line hidden
#line 76
...
#line 77
 testRunner.When("User adds columns to the list", ((string)(null)), table3455, "When ");
#line hidden
#line 81
 testRunner.Then("Edit List menu is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 84
 testRunner.When(string.Format("User create static list with \"StaticList\" name on \"{0}\" page with following items" +
                            "", listName), ((string)(null)), table3456, "When ");
#line hidden
#line 87
 testRunner.When("User clicks the Columns button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
                ...
                table3457.AddRow(new string[] {
                            string.Format("{0}", newColumnName)});
#line 88
 testRunner.And("User adds columns to the list", ((string)(null)), table3457, "And ");
#line hidden
#line 91
 testRunner.Then("Edit List menu is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
                ...
                table3458.AddRow(new string[] {
                            string.Format("{0}", addAnotherColumn)});
#line 92
 testRunner.When("User adds columns to the list", ((string)(null)), table3458, "When ");
#line hidden
#line 96
 testRunner.Then("Edit List menu is displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 134
 testRunner.Then("User enters SearchCriteria into the agGrid Search Box and the correct NumberOfRow" +
                        "s are returned", ((string)(null)), table3461, "Then ");
#line hidden
#line 137
 testRunner.Then("Edit List menu is not displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
