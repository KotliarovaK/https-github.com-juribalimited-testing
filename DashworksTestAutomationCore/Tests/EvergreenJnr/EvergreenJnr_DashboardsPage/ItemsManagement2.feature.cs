...
#line 34
 testRunner.When("User add \"Device (Saved List)\" filter where type is \"In list\" with following Look" +
                        "up Value and Association:", ((string)(null)), table2132, "When ");
#line hidden
#line 37
...
#line 60
 testRunner.When("User clicks cogmenu for \'Dashboard_DAS15877\' list and sees following cog-menu opt" +
                        "ions", ((string)(null)), table2134, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2138.AddRow(new string[] {
                            "1_Widget2"});
#line 149
 testRunner.Then("User sees following Widgets in one Section on Dashboards page:", ((string)(null)), table2138, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
