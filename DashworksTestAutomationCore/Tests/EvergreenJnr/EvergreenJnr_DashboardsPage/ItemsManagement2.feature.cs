...
#line 34
 testRunner.When("User add \"Device (Saved List)\" filter where type is \"In list\" with following Look" +
                        "up Value and Association:", ((string)(null)), table2133, "When ");
#line hidden
#line 37
...
#line 60
 testRunner.When("User clicks cogmenu for \'Dashboard_DAS15877\' list and sees following cog-menu opt" +
                        "ions", ((string)(null)), table2135, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2139.AddRow(new string[] {
                            "1_Widget2"});
#line 149
 testRunner.Then("User sees following Widgets in one Section on Dashboards page:", ((string)(null)), table2139, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2141.AddRow(new string[] {
                            ...
                            "Hostname ASC"});
#line 200
 testRunner.When("User creates new Widget", ((string)(null)), table2141, "When ");
#line hidden
#line 203
