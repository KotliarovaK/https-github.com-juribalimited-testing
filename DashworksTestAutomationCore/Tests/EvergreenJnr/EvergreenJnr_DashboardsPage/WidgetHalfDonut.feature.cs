...
#line 12
 testRunner.And("User adds new Widget", ((string)(null)), table1615, "And ");
#line hidden
                ...
                table1616.AddRow(new string[] {
                            "Count DESC"});
#line 15
 testRunner.Then("User sees following options for Order By selector on Create Widget page:", ((string)(null)), table1616, "Then ");
#line hidden
            }
...
#line hidden
                ...
                table1617.AddRow(new string[] {
                            "HDD Total Size (GB)"});
#line 25
 testRunner.When("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table1617, "When ");
#line hidden
#line 28
...
#line 32
 testRunner.And("User adds new Widget", ((string)(null)), table1618, "And ");
#line hidden
#line 35
