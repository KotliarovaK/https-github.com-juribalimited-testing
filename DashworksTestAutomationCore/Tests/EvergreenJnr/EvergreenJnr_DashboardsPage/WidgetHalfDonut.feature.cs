...
#line hidden
                ...
                table2216.AddRow(new string[] {
                            "Count DESC"});
#line 15
 testRunner.Then("User sees following options for Order By selector on Create Widget page:", ((string)(null)), table2216, "Then ");
#line hidden
            }
...
#line hidden
                ...
                table2217.AddRow(new string[] {
                            "HDD Total Size (GB)"});
#line 25
 testRunner.When("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table2217, "When ");
#line hidden
#line 28
