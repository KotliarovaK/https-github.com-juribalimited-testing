...
#line 12
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2241, "And ");
#line hidden
#line 15
...
#line hidden
                ...
                table2242.AddRow(new string[] {
                            "00SH8162NAS524"});
#line 16
 testRunner.And("User select \"Hostname\" rows in the grid", ((string)(null)), table2242, "And ");
#line hidden
#line 21
...
#line hidden
                ...
                table2244.AddRow(new string[] {
                            ...
                            "20"});
#line 31
 testRunner.And("User creates new Widget", ((string)(null)), table2244, "And ");
#line hidden
#line 34
...
#line hidden
                ...
                table2246.AddRow(new string[] {
                            ...
                            "false"});
#line 46
 testRunner.And("User adds new Widget", ((string)(null)), table2246, "And ");
#line hidden
#line 49
...
#line hidden
                ...
                table2251.AddRow(new string[] {
                            ...
                            "5"});
#line 124
 testRunner.And("User creates new Widget", ((string)(null)), table2251, "And ");
#line hidden
#line 127
...
#line hidden
                ...
                table2254.AddRow(new string[] {
                            "Windows7Mi: Communication \\ DateTime"});
#line 183
 testRunner.Then("User sees following options for Aggregate By selector on Create Widget page:", ((string)(null)), table2254, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2258.AddRow(new string[] {
                            "Count DESC"});
#line 248
 testRunner.And("User sees following options for Order By selector on Create Widget page:", ((string)(null)), table2258, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 283
 testRunner.Then("User sees following options for Order By selector on Create Widget page:", ((string)(null)), table2260, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2261.AddRow(new string[] {
                            "HDD Total Size (GB)"});
#line 293
 testRunner.When("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table2261, "When ");
#line hidden
#line 296
...
#line 387
 testRunner.When("User add \"Owner Compliance\" filter where type is \"Does not equal\" with added colu" +
                        "mn and following checkboxes:", ((string)(null)), table2269, "When ");
#line hidden
#line 394
...
#line hidden
                ...
                table2270.AddRow(new string[] {
                            ...
                            "true"});
#line 400
 testRunner.And("User adds new Widget", ((string)(null)), table2270, "And ");
#line hidden
#line 403
...
#line 409
 testRunner.Then("Data Legends values are displayed in \'WidgetForDAS17467\' widget on the Dashboard " +
                        "page", ((string)(null)), table2271, "Then ");
#line hidden
#line 413
...
#line 421
 testRunner.When("User add \"2004: Readiness\" filter where type is \"Does not equal\" with added colum" +
                        "n and following checkboxes:", ((string)(null)), table2272, "When ");
#line hidden
#line 427
...
#line 446
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2274, "When ");
#line hidden
#line 450
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 452
 testRunner.When("User add \"Windows7Mi: In Scope\" filter where type is \"Equals\" with added column a" +
                        "nd following checkboxes:", ((string)(null)), table2275, "When ");
#line hidden
#line 455
...
#line 524
 testRunner.When("User add \"2004: Readiness\" filter where type is \"Equals\" with added column and fo" +
                        "llowing checkboxes:", ((string)(null)), table2280, "When ");
#line hidden
#line 530
 testRunner.When("User clicks Save button on the list panel", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
