...
#line 32
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2235, "When ");
#line hidden
                ...
                table2236.AddRow(new string[] {
                            "Windows7Mi: Rationalisation"});
#line 35
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table2236, "Then ");
#line hidden
#line 38
...
#line 40
 testRunner.When("User add \"Vendor\" filter where type is \"Equals\" with added column and following v" +
                        "alue:", ((string)(null)), table2237, "When ");
#line hidden
#line 43
...
#line hidden
                ...
                table2239.AddRow(new string[] {
                            "Microsoft"});
#line 53
 testRunner.Then("following content is displayed in the \'Vendor\' column for Widget", ((string)(null)), table2239, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 75
 testRunner.And("User add \"Owner Display Name\" filter where type is \"Equals\" with added column and" +
                        " following value:", ((string)(null)), table2241, "And ");
#line hidden
#line 78
