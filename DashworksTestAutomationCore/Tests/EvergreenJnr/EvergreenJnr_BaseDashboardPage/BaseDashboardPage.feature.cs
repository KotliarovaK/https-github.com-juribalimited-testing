...
#line 41
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table1499, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1500.AddRow(new string[] {
                            "Version"});
#line 57
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table1500, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1501.AddRow(new string[] {
                            "Owner Display Name"});
#line 67
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table1501, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 132
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1502, "When ");
#line hidden
#line 137
...
#line 153
 testRunner.When("User add \"Compliance\" filter where type is \"Equals\" with added column and followi" +
                        "ng checkboxes:", ((string)(null)), table1503, "When ");
#line hidden
#line 156
...
#line 157
 testRunner.When("User add \"Compliance\" filter where type is \"Equals\" with added column and followi" +
                        "ng checkboxes:", ((string)(null)), table1504, "When ");
#line hidden
#line 160
 testRunner.Then("\"Compliance\" column is added to URL on \"Users\" page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 165
 testRunner.When("User add \"User Application Compliance\" filter where type is \"Equals\" with added c" +
                        "olumn and following checkboxes:", ((string)(null)), table1505, "When ");
#line hidden
#line 168
...
#line 184
 testRunner.And("User adds columns to the list", ((string)(null)), table1506, "And ");
#line hidden
#line 187
...
#line hidden
                ...
                table1507.AddRow(new string[] {
                            "PIVOT"});
#line 249
 testRunner.And("User sees that \'Create\' dropdown contains following options:", ((string)(null)), table1507, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1508.AddRow(new string[] {
                            "PIVOT"});
#line 265
 testRunner.And("User sees that \'Create\' dropdown contains following options:", ((string)(null)), table1508, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1509.AddRow(new string[] {
                            ...
                            "10"});
#line 301
 testRunner.And("User creates new Widget", ((string)(null)), table1509, "And ");
#line hidden
#line 304
...
#line 316
 testRunner.When("User creates new clear User", ((string)(null)), table1510, "When ");
#line hidden
#line 319
...
#line hidden
                ...
                table1511.AddRow(new string[] {
                            ...
                            "1234qwer"});
#line 324
 testRunner.When("User login with following credentials:", ((string)(null)), table1511, "When ");
#line hidden
#line 327
