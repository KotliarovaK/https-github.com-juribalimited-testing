...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Buckets
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("GridScreenBuckets", Description="\tGrid Screen Buckets", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Buckets\\GridScreenBuckets.feature", SourceLine=0)]
...
#line 26
 testRunner.When("User checks following checkboxes in the filter dropdown menu for the \'Default\' co" +
                        "lumn:", ((string)(null)), table674, "When ");
#line hidden
#line 29
 testRunner.Then("There are no errors in the browser console", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckSelectedRowsCountDisplayingOnBucketsGrids", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckDefaultSortOrderOfBucketsAfterCreateOrUpdateOrDeleteA" +
            "ction", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
...
#line hidden
                ...
                table675.AddRow(new string[] {
                            ...
                            "IB Team"});
#line 90
 testRunner.When("User creates new Bucket via api", ((string)(null)), table675, "When ");
#line hidden
#line 98
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
