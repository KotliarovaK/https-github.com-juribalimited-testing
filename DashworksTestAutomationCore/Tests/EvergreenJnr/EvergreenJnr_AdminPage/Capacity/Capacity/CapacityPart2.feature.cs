...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Capacity.Capacity
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("CapacityPart2", Description="\tRuns Capacity related tests on Admin page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Capacity\\Capacity\\CapacityPart2.feature" +
        "", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatCorrectLinkIsDisplayedInTheGreenBannerForCreatedU" +
            "nit", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
                ...
                table835.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 10
 testRunner.When("Project created via API and opened", ((string)(null)), table835, "When ");
#line hidden
#line 13
...
#line hidden
                ...
                table836.AddRow(new string[] {
                            ...
                            "ProjectForCapacity13790"});
#line 33
 testRunner.And("User creates new Capacity Unit via api", ((string)(null)), table836, "And ");
#line hidden
#line 37
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatOneDefaultCapacityUnitCanBeCreated", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
...
#line hidden
                ...
                table837.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 46
 testRunner.When("Project created via API and opened", ((string)(null)), table837, "When ");
#line hidden
#line 49
 testRunner.And("User navigates to the \'Capacity\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table838.AddRow(new string[] {
                            "Unassigned"});
#line 51
 testRunner.Then("User sees next Units on the Capacity Units page:", ((string)(null)), table838, "Then ");
#line hidden
#line 54
...
#line hidden
                ...
                table839.AddRow(new string[] {
                            "Unassigned"});
#line 55
 testRunner.When("User select \"Capacity Unit\" rows in the grid", ((string)(null)), table839, "When ");
#line hidden
#line 58
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatCapacityUnitsGridUpdatedAfterUnitUpdatingOrCreati" +
            "on", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
...
#line hidden
                ...
                table840.AddRow(new string[] {
                            ...
                            "Email Migration"});
#line 93
 testRunner.When("User creates new Capacity Unit via api", ((string)(null)), table840, "When ");
#line hidden
#line 96
...
#line hidden
                ...
                table841.AddRow(new string[] {
                            "CapacityUnit14240"});
#line 115
 testRunner.Then("User sees next Units on the Capacity Units page:", ((string)(null)), table841, "Then ");
#line hidden
#line 119
...
#line 124
 testRunner.And("User sees next Units on the Capacity Units page:", ((string)(null)), table842, "And ");
#line hidden
                ...
                table843.AddRow(new string[] {
                            "CapacityUnit14240NameUpdated"});
#line 128
 testRunner.When("User select \"Capacity Unit\" rows in the grid", ((string)(null)), table843, "When ");
#line hidden
#line 131
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatUserCantCreateCapacityUnitWithEmptyName", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
