...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Capacity.Capacity
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("CapacityPart4", Description="\tRuns Capacity related tests on Admin page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Capacity\\Capacity\\CapacityPart4.feature" +
        "", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_ChecksThatCorrectlMessageAppearsWhenDefaultLanguageDoesNot" +
...
#line 15
 testRunner.And("User expands multiselect and selects following Objects", ((string)(null)), table855, "And ");
#line hidden
#line 18
...
#line hidden
                ...
                table856.AddRow(new string[] {
                            "1A701E05916148A6A3F"});
#line 33
 testRunner.Then("Following items displayed in the History table", ((string)(null)), table856, "Then ");
#line hidden
#line 36
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckingPercentageCapacityToReachBeforeShowingAmberField", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_ChecksThatOriginalCapacityUnitStoredAndDisplayedIfCapacity" +
...
#line hidden
                ...
                table858.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 54
 testRunner.When("Project created via API and opened", ((string)(null)), table858, "When ");
#line hidden
#line 57
 testRunner.And("User navigates to the \'Scope\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table859.AddRow(new string[] {
                            "001BAQXT6JWFPI"});
#line 61
 testRunner.When("User expands multiselect and selects following Objects", ((string)(null)), table859, "When ");
#line hidden
#line 64
 testRunner.And("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table860.AddRow(new string[] {
                            "001BAQXT6JWFPI"});
#line 67
 testRunner.Then("following Items are displayed in the History table", ((string)(null)), table860, "Then ");
#line hidden
#line 70
