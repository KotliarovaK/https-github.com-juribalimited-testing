...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Capacity.Capacity
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("CapacityPart1", Description="\tRuns Capacity related tests on Admin page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Capacity\\Capacity\\CapacityPart1.feature" +
        "", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatDefaultCapacityUnitRenamedInUnassignedWithoutErro" +
            "rs", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
                ...
                table828.AddRow(new string[] {
                            "Applications"});
#line 22
 testRunner.And("grid headers are displayed in the following order", ((string)(null)), table828, "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckDefaultColumnsForDevicesProjectCapacityUnits", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
...
#line hidden
                ...
                table829.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 35
 testRunner.When("Project created via API and opened", ((string)(null)), table829, "When ");
#line hidden
#line 38
 testRunner.And("User navigates to the \'Capacity\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table830.AddRow(new string[] {
                            "Applications"});
#line 40
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table830, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckDefaultColumnsForMailboxesProjectCapacityUnits", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
...
#line hidden
                ...
                table831.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 53
 testRunner.When("Project created via API and opened", ((string)(null)), table831, "When ");
#line hidden
#line 56
 testRunner.And("User navigates to the \'Capacity\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table832.AddRow(new string[] {
                            "Applications"});
#line 58
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table832, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatUnlimitedValueIsDisplayedForCapacityColumn", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "Capacity",
