...
#line hidden
                ...
                table722.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 46
 testRunner.When("Project created via API and opened", ((string)(null)), table722, "When ");
#line hidden
                ...
                table723.AddRow(new string[] {
                            ...
                            "13442"});
#line 49
 testRunner.And("User creates new Slot via Api", ((string)(null)), table723, "And ");
#line hidden
#line 52
...
#line hidden
                ...
                table724.AddRow(new string[] {
                            "Slot13442"});
#line 73
 testRunner.When("User select \"Capacity Slot\" rows in the grid", ((string)(null)), table724, "When ");
#line hidden
#line 76
...
#line 101
 testRunner.Then("only below options are selected in the \'Tasks\' autocomplete", ((string)(null)), table725, "Then ");
#line hidden
...
#line hidden
                ...
                table729.AddRow(new string[] {
                            "Pre-Migration \\ Scheduled Date"});
#line 129
 testRunner.Then("only below options are selected in the \'Tasks\' autocomplete", ((string)(null)), table729, "Then ");
#line hidden
...
#line 149
 testRunner.Then("\'Paths\' autocomplete have following checkbox options", ((string)(null)), table732, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
