...
#line hidden
                ...
                table1613.AddRow(new string[] {
                            "VSCmdShell"});
#line 10
 testRunner.Given("User resync \'Application\' objects for \'2004 Rollout\' project", ((string)(null)), table1613, "Given ");
#line hidden
...
#line 13
 testRunner.When("User create static list with \"DAS_20421\" name on \"Applications\" page with followi" +
                        "ng items", ((string)(null)), table1614, "When ");
#line hidden
                ...
                table1615.AddRow(new string[] {
                            ...
                            "DAS_20421"});
#line 20
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1615, "When ");
#line hidden
...
#line 23
 testRunner.When("User creates new application ownership component for \'Welcome\' Self Service page " +
                        "via API", ((string)(null)), table1616, "When ");
#line hidden
#line 26
...
#line 29
 testRunner.Then("User sees following items for \'AOC Name\' application ownership component on \'Welc" +
                        "ome\' end user page", ((string)(null)), table1617, "Then ");
#line hidden
#line 34
...
#line hidden
                ...
                table1618.AddRow(new string[] {
                            ...
                            ""});
#line 39
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table1618, "Then ");
#line hidden
            }
...
#line hidden
                ...
                table1619.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 45
 testRunner.When("Project created via API and opened", ((string)(null)), table1619, "When ");
#line hidden
#line 49
...
#line 52
 testRunner.When("User expands \'Users to add\' multiselect to the \'Users\' tab on Project Scope Chang" +
                        "es page and selects following Objects", ((string)(null)), table1620, "When ");
#line hidden
#line 56
...
#line 60
    testRunner.When("User expands \'Applications to add\' multiselect to the \'Applications\' tab on Proje" +
                        "ct Scope Changes page and selects following Objects", ((string)(null)), table1621, "When ");
#line hidden
#line 63
    testRunner.When("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 65
 testRunner.When("User create static list with \"DAS_20421_forComponent\" name on \"Users\" page with f" +
                        "ollowing items", ((string)(null)), table1622, "When ");
#line hidden
...
#line 69
 testRunner.When("User create static list with \"DAS_20421\" name on \"Applications\" page with followi" +
                        "ng items", ((string)(null)), table1623, "When ");
#line hidden
                ...
                table1624.AddRow(new string[] {
                            ...
                            "DAS_20421"});
#line 72
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1624, "When ");
#line hidden
...
#line 75
 testRunner.When("User creates new application ownership component for \'Welcome\' Self Service page " +
                        "via API", ((string)(null)), table1625, "When ");
#line hidden
#line 78
 testRunner.When("User navigates to End User landing page with \'20421_1_SI\' Self Service Identifier" +
                        "", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
...
#line 89
 testRunner.Then("User sees following items for \'AOC Name\' application ownership component on \'Welc" +
                        "ome\' end user page", ((string)(null)), table1626, "Then ");
#line hidden
#line 94
 testRunner.When("User clicks on \'Continue\' button on end user Self Service page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1627.AddRow(new string[] {
                            ...
                            "Jones Tina"});
#line 100
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table1627, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 175
 testRunner.Then("only below options are displayed in \'Owner\' autocomplete after search by \'03C54BC" +
                        "1198843A4A03 (Jones, Tina)\' text", ((string)(null)), table1638, "Then ");
#line hidden
#line 178
 testRunner.When("User clicks on \'Change Owner\' button on end user Self Service page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1639.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 184
 testRunner.When("Project created via API and opened", ((string)(null)), table1639, "When ");
#line hidden
#line 188
 testRunner.When("User navigates to the \'Scope\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 191
 testRunner.And("User expands \'Users to add\' multiselect to the \'Users\' tab on Project Scope Chang" +
                        "es page and selects following Objects", ((string)(null)), table1640, "And ");
#line hidden
#line 195
 testRunner.And("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 200
 testRunner.And("User expands \'Applications to add\' multiselect to the \'Applications\' tab on Proje" +
                        "ct Scope Changes page and selects following Objects", ((string)(null)), table1641, "And ");
#line hidden
#line 203
 testRunner.And("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 206
 testRunner.When("User create static list with \"DAS_20425_forComponent\" name on \"Users\" page with f" +
                        "ollowing items", ((string)(null)), table1642, "When ");
#line hidden
...
#line 223
 testRunner.Then("User sees following items for \'AOC Name\' application ownership component on \'Welc" +
                        "ome\' end user page", ((string)(null)), table1646, "Then ");
#line hidden
#line 228
 testRunner.When("User clicks on \'Continue\' button on end user Self Service page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1647.AddRow(new string[] {
                            ...
                            "Jones Tina"});
#line 234
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table1647, "Then ");
#line hidden
#line 237
 testRunner.When("User navigates to End User landing page with \'20425_1_SI\' Self Service Identifier" +
                        "", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
...
#line 241
 testRunner.Then("User sees following items for \'AOC Name\' application ownership component on \'Welc" +
                        "ome\' end user page", ((string)(null)), table1648, "Then ");
#line hidden
#line 246
 testRunner.When("User clicks on \'Continue\' button on end user Self Service page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1649.AddRow(new string[] {
                            ...
                            ""});
#line 252
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table1649, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
