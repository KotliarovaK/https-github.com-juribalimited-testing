...
Scenario: EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatUndoAllChangesIMadeOnThisPageButtonIsntPresent
	...
	#TO DO: Replace the step below as soon as DAS-20451 will be implemented
	When User navigates to End User landing page with 'DAS_20330_SS_1' Self Service Identifier, 'DAS_20330_forComponent_1' scope list and 'DAS_20330_Proj_1' project name
	...
	| AOC Name      | DAS_20330_Proj | Do not allow owner to be changed | DAS_20330_forComponent_1 |
	#TO DO: Replace the step below as soon as DAS-20451 will be implemented
	When User navigates to End User landing page with 'DAS_20330_SS_1' Self Service Identifier, 'DAS_20330_forComponent_1' scope list and 'DAS_20330_Proj_1' project name
