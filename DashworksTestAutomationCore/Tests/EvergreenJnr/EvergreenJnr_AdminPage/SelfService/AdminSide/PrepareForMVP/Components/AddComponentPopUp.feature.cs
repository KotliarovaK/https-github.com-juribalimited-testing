...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.Components
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("AddComponentPopUp", Description="\tTests that are related to Add Component PopUp", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Com" +
        "ponents\\AddComponentPopUp.feature", SourceLine=0)]
...
#line 10
 testRunner.When("User create static list with \"SelfServiceStaticAppList\" name on \"Applications\" pa" +
                        "ge with following items", ((string)(null)), table1475, "When ");
#line hidden
...
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1476, "When ");
#line hidden
                ...
                table1477.AddRow(new string[] {
                            ...
                            "false"});
#line 16
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1477, "When ");
#line hidden
#line 19
