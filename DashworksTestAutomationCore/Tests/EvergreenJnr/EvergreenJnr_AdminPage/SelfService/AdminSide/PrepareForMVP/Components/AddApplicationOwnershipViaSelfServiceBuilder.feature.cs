...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.Components
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("AddApplicationOwnershipViaSelfServiceBuilder", Description="\tAdd Application Ownership via Self Service builder", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Com" +
        "ponents\\AddApplicationOwnershipViaSelfServiceBuilder.feature", SourceLine=0)]
...
#line 10
 testRunner.When("User create static list with \"SelfServiceStaticAppList\" name on \"Applications\" pa" +
                        "ge with following items", ((string)(null)), table1468, "When ");
#line hidden
...
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1469, "When ");
#line hidden
                ...
                table1470.AddRow(new string[] {
                            ...
                            "false"});
#line 16
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1470, "When ");
#line hidden
#line 20
...
#line 34
 testRunner.When("User create static list with \"SelfServiceStaticAppList\" name on \"Applications\" pa" +
                        "ge with following items", ((string)(null)), table1471, "When ");
#line hidden
                ...
                table1472.AddRow(new string[] {
                            ...
                            "SelfServiceStaticAppList"});
#line 37
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1472, "When ");
#line hidden
                ...
                table1473.AddRow(new string[] {
                            ...
                            "false"});
#line 40
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1473, "When ");
#line hidden
#line 44
 testRunner.Then("Self Service Details page is displayed correctly", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
