...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SelfServiceAgGrid", Description="\tSelf Service", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Sel" +
        "fServiceAgGrid.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckGeneralViewOfSelfServiceAgGrid", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
                ...
                table1607.AddRow(new string[] {
                            ...
                            "bob"});
#line 10
    testRunner.When("User creates Self Service via API", ((string)(null)), table1607, "When ");
#line hidden
#line 17
...
#line hidden
                ...
                table1608.AddRow(new string[] {
                            "Created Date"});
#line 19
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table1608, "Then ");
#line hidden
#line 29
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckSelfServiceAgGridSelection", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line hidden
                ...
                table1609.AddRow(new string[] {
                            ...
                            "bob"});
#line 34
    testRunner.When("User creates Self Service via API", ((string)(null)), table1609, "When ");
#line hidden
#line 41
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatSelfServiceCogMenuDisplaysProperly", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line hidden
                ...
                table1610.AddRow(new string[] {
                            ...
                            "bob"});
#line 54
    testRunner.When("User creates Self Service via API", ((string)(null)), table1610, "When ");
#line hidden
#line 58
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 60
 testRunner.When("User clicks Cog-menu for \'TestSelfServiceCogMenu_name1\' item in the \'Self Service" +
                        " Name\' column and sees following cog-menu options", ((string)(null)), table1611, "When ");
#line hidden
...
#line 65
 testRunner.When("User clicks Cog-menu for \'TestSelfServiceCogMenu_name5\' item in the \'Self Service" +
                        " Name\' column and sees following cog-menu options", ((string)(null)), table1612, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
