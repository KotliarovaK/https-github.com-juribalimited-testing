...
#line hidden
                ...
                table1199.AddRow(new string[] {
                            ...
                            "DAS_20407"});
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1199, "When ");
#line hidden
                ...
                table1200.AddRow(new string[] {
                            ...
                            "true"});
#line 16
 testRunner.When("User creates new text component for \'Welcome\' Self Service page via API", ((string)(null)), table1200, "When ");
#line hidden
#line 21
...
#line 22
 testRunner.Then("User clicks on cogmenu button for item with \'Text\' type and \'Text_Component_Name_" +
                        "1\' name on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1201, "Then ");
#line hidden
...
#line 28
 testRunner.Then("User clicks on cogmenu button for item with \'Text\' type and \'Text_Component_Name_" +
                        "2\' name on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1202, "Then ");
#line hidden
...
#line 35
 testRunner.Then("User clicks on cogmenu button for item with \'Text\' type and \'Text_Component_Name_" +
                        "3\' name on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1203, "Then ");
#line hidden
#line 41
...
#line hidden
                ...
                table1204.AddRow(new string[] {
                            ...
                            "1"});
#line 44
 testRunner.Then("User sees component on position in \'Welcome\' page of Self Service Builder Panel", ((string)(null)), table1204, "Then ");
#line hidden
            }
...
#line hidden
                ...
                table1206.AddRow(new string[] {
                            ...
                            "DAS_20407"});
#line 55
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1206, "When ");
#line hidden
                ...
                table1207.AddRow(new string[] {
                            ...
                            "true"});
#line 58
 testRunner.When("User creates new text component for \'Welcome\' Self Service page via API", ((string)(null)), table1207, "When ");
#line hidden
#line 61
 testRunner.When("User navigates to the \'Builder\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
