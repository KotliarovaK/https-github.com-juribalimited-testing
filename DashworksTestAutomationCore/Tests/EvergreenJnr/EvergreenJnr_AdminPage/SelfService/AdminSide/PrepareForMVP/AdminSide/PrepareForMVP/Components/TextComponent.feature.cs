...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.AdminSide.PrepareForMVP.Components
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("TextComponent", Description="\tText Component", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Adm" +
        "inSide\\PrepareForMVP\\Components\\TextComponent.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_TextComponentUiCheckForCreatePage", new string[] {
                "Evergreen",
                "Admin",
...
#line 10
 testRunner.When("User create static list with \"DAS_19979_11\" name on \"Users\" page with following i" +
                        "tems", ((string)(null)), table1340, "When ");
#line hidden
                ...
                table1341.AddRow(new string[] {
                            ...
                            "DAS_19979_11"});
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1341, "When ");
#line hidden
                ...
                table1342.AddRow(new string[] {
                            ...
                            "true"});
#line 16
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1342, "When ");
#line hidden
#line 19
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_TextComponentUiCheckForUpdatePage", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line 38
 testRunner.When("User create static list with \"DAS_19979_22\" name on \"Users\" page with following i" +
                        "tems", ((string)(null)), table1343, "When ");
#line hidden
                ...
                table1344.AddRow(new string[] {
                            ...
                            "DAS_19979_22"});
#line 41
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1344, "When ");
#line hidden
                ...
                table1345.AddRow(new string[] {
                            ...
                            "true"});
#line 44
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1345, "When ");
#line hidden
                ...
                table1346.AddRow(new string[] {
                            ...
                            "true"});
#line 47
 testRunner.When("User creates new text component for \'TestPageSs3\' Self Service page via API", ((string)(null)), table1346, "When ");
#line hidden
#line 50
 testRunner.When("User navigates to the \'Builder\' left submenu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 91
 testRunner.Then("text editor contains text", ((string)(null)), table1348, "Then ");
#line hidden
#line 94
 testRunner.Then("\'Show this component\' checkbox is unchecked", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_TextComponentUiCheckForCancelUpdateFunctionality", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line 98
 testRunner.When("User create static list with \"DAS_20049_33\" name on \"Users\" page with following i" +
                        "tems", ((string)(null)), table1349, "When ");
#line hidden
                ...
                table1350.AddRow(new string[] {
                            ...
                            "DAS_20049_33"});
#line 101
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1350, "When ");
#line hidden
                ...
                table1351.AddRow(new string[] {
                            ...
                            "true"});
#line 104
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1351, "When ");
#line hidden
                ...
                table1352.AddRow(new string[] {
                            ...
                            "true"});
#line 107
 testRunner.When("User creates new text component for \'TestPageSs4\' Self Service page via API", ((string)(null)), table1352, "When ");
#line hidden
#line 110
 testRunner.When("User navigates to the \'Builder\' left submenu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1353.AddRow(new string[] {
                            "Additional Text"});
#line 121
 testRunner.Then("text editor does not contains text", ((string)(null)), table1353, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatTextEditorOptionsIsAvailableForTextComponent", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line hidden
                ...
                table1355.AddRow(new string[] {
                            ...
                            "DAS_20160"});
#line 130
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1355, "When ");
#line hidden
                ...
                table1356.AddRow(new string[] {
                            ...
                            "true"});
#line 133
 testRunner.When("User creates new text component for \'Welcome\' Self Service page via API", ((string)(null)), table1356, "When ");
#line hidden
#line 136
 testRunner.When("User navigates to the \'Builder\' left submenu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1357.AddRow(new string[] {
                            "Normal"});
#line 139
 testRunner.Then("header format options are displayed on the text component", ((string)(null)), table1357, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
