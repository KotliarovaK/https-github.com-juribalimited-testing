...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.AdminSide.PrepareForMVP.Builder
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ManageComponents", Description="\tManage Components tests", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Adm" +
        "inSide\\PrepareForMVP\\Builder\\ManageComponents.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatWhenСomponentIsSelectedAnd" +
            "TheUserCollapsesThePagesBranchThePageItemHasAnOrangeBorderAndNotOrangeText", new string[] {
                "Evergreen",
                "Admin",
...
#line 10
 testRunner.When("User create static list with \"SelfServiceStaticAppList\" name on \"Applications\" pa" +
                        "ge with following items", ((string)(null)), table1237, "When ");
#line hidden
...
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1238, "When ");
#line hidden
                ...
                table1239.AddRow(new string[] {
                            ...
                            "false"});
#line 16
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1239, "When ");
#line hidden
