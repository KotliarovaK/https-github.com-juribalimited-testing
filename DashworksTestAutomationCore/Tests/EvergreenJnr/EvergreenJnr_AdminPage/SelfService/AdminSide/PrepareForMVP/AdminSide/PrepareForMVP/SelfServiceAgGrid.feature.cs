...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.AdminSide.PrepareForMVP
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SelfServiceGrid", Description="\tSelf Service", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Adm" +
        "inSide\\PrepareForMVP\\SelfServiceAgGrid.feature", SourceLine=0)]
...
#line hidden
                ...
                table1409.AddRow(new string[] {
                            ...
                            "bob"});
#line 10
    testRunner.When("User creates Self Service via API", ((string)(null)), table1409, "When ");
#line hidden
#line 17
...
#line hidden
                ...
                table1410.AddRow(new string[] {
                            "Created Date"});
#line 19
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table1410, "Then ");
#line hidden
#line 29
...
#line hidden
                ...
                table1412.AddRow(new string[] {
                            ...
                            "bob"});
#line 54
    testRunner.When("User creates Self Service via API", ((string)(null)), table1412, "When ");
#line hidden
#line 58
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 65
 testRunner.When("User clicks Cog-menu for \'TestSelfServiceCogMenu_name5\' item in the \'Self Service" +
                        " Name\' column and sees following cog-menu options", ((string)(null)), table1414, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
