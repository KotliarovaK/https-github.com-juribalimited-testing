...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.AdminSide
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("CreateSelfServiceMvp", Description="\tCrete Self Service MVP", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Adm" +
        "inSide\\CreateSelfServiceMvp.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatTwoPagesWillBeCreatedByDef" +
            "aultWhenNewSelfServiceIsCreated", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatUserIsAbleToEditTheNamesIn" +
            "EditMode", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatProperOptionsAreDisabledIn" +
            "CogMenuAndCreatePageButtonDoesntDisplay", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line 77
    testRunner.When("User create static list with \"1803 Apps\" name on \"Applications\" page with followi" +
                        "ng items", ((string)(null)), table1212, "When ");
#line hidden
#line 80
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 88
 testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'Welcome\' name on Sel" +
                        "f Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1213, "Then ");
#line hidden
...
#line 91
 testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'Thank You\' name on S" +
                        "elf Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1214, "Then ");
#line hidden
#line 94
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatUserIsAbleToAddOnlyOneAppl" +
            "icationOwnershipComponentToTheFirstPageAndUableToAddItToTheLastOne", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_EvergreenJnr_AdminPage_CheckThatTheBannerAboutCreatedSelfS" +
            "erviceWontBeDisplayedIfUserSwitchBetweenPages", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "SelfService",
...
#line 127
    testRunner.When("User create static list with \"1803 Apps\" name on \"Applications\" page with followi" +
                        "ng items", ((string)(null)), table1216, "When ");
#line hidden
#line 130
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
