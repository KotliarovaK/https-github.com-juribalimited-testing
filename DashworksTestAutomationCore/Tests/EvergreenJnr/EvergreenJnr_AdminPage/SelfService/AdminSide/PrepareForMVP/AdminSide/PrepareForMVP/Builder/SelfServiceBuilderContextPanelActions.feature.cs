...
#line hidden
                ...
                table1244.AddRow(new string[] {
                            ...
                            "1803 Apps"});
#line 28
    testRunner.When("User creates Self Service via API", ((string)(null)), table1244, "When ");
#line hidden
#line 31
    testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 50
 testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'TestPageName_3\' name" +
                        " on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1248, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
