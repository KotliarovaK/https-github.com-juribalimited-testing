...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.AdminSide.PrepareForMVP.Builder
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("SelfServiceBuilderContextPanelActions", Description="\tSelf Service", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Adm" +
        "inSide\\PrepareForMVP\\Builder\\SelfServiceBuilderContextPanelActions.feature", SourceLine=0)]
...
#line hidden
                ...
                table1241.AddRow(new string[] {
                            ...
                            "1803 Apps"});
#line 10
    testRunner.When("User creates Self Service via API", ((string)(null)), table1241, "When ");
#line hidden
#line 13
...
#line hidden
                ...
                table1242.AddRow(new string[] {
                            ...
                            "true"});
#line 17
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1242, "When ");
#line hidden
#line 22
...
#line hidden
                ...
                table1243.AddRow(new string[] {
                            ...
                            "1803 Apps"});
#line 28
    testRunner.When("User creates Self Service via API", ((string)(null)), table1243, "When ");
#line hidden
#line 31
    testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1244.AddRow(new string[] {
                            ...
                            "true"});
#line 35
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1244, "When ");
#line hidden
#line 40
 testRunner.When("User navigates to the \'Builder\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 41
    testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'TestPageName_1\' name" +
                        " on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1245, "Then ");
#line hidden
...
#line 45
 testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'TestPageName_2\' name" +
                        " on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1246, "Then ");
#line hidden
...
#line 50
 testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'TestPageName_3\' name" +
                        " on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1247, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
