...
#line hidden
                ...
                table1287.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 10
 testRunner.When("Project created via API", ((string)(null)), table1287, "When ");
#line hidden
...
#line 13
 testRunner.When("User create static list with \"DAS_20019_1\" name on \"Applications\" page with follo" +
                        "wing items", ((string)(null)), table1288, "When ");
#line hidden
...
#line 16
 testRunner.When("User create static list with \"DAS_20019_11\" name on \"Users\" page with following i" +
                        "tems", ((string)(null)), table1289, "When ");
#line hidden
                ...
                table1290.AddRow(new string[] {
                            ...
                            "DAS_20019_1"});
#line 19
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1290, "When ");
#line hidden
                ...
                table1291.AddRow(new string[] {
                            ...
                            "true"});
#line 22
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1291, "When ");
#line hidden
#line 26
...
#line hidden
                ...
                table1293.AddRow(new string[] {
                            "DAS_20019_Proj"});
#line 44
 testRunner.Then("\'Project\' autocomplete contains following options:", ((string)(null)), table1293, "Then ");
#line hidden
#line 47
...
#line hidden
                ...
                table1294.AddRow(new string[] {
                            "DAS_20019_11"});
#line 56
 testRunner.Then("\'User Scope\' autocomplete contains following options:", ((string)(null)), table1294, "Then ");
#line hidden
#line 60
...
#line hidden
                ...
                table1297.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 74
 testRunner.When("Project created via API and opened", ((string)(null)), table1297, "When ");
#line hidden
...
#line 77
 testRunner.When("User create static list with \"DAS_19909_2\" name on \"Applications\" page with follo" +
                        "wing items", ((string)(null)), table1298, "When ");
#line hidden
...
#line 80
 testRunner.When("User create static list with \"DAS_19909_3\" name on \"Users\" page with following it" +
                        "ems", ((string)(null)), table1299, "When ");
#line hidden
                ...
                table1300.AddRow(new string[] {
                            ...
                            "DAS_19909_2"});
#line 83
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1300, "When ");
#line hidden
                ...
                table1301.AddRow(new string[] {
                            ...
                            "true"});
#line 86
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1301, "When ");
#line hidden
...
#line 90
 testRunner.When("User creates new application ownership component for \'TestPageSs1\' Self Service p" +
                        "age via API", ((string)(null)), table1302, "When ");
#line hidden
#line 93
 testRunner.When("User navigates to the \'Builder\' left submenu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1303.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 124
 testRunner.When("Project created via API", ((string)(null)), table1303, "When ");
#line hidden
                ...
                table1304.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 127
 testRunner.When("Project created via API and opened", ((string)(null)), table1304, "When ");
#line hidden
...
#line 130
 testRunner.When("User create static list with \"DAS_19909_2\" name on \"Applications\" page with follo" +
                        "wing items", ((string)(null)), table1305, "When ");
#line hidden
...
#line 133
 testRunner.When("User create static list with \"DAS_19909_3\" name on \"Users\" page with following it" +
                        "ems", ((string)(null)), table1306, "When ");
#line hidden
                ...
                table1307.AddRow(new string[] {
                            ...
                            "DAS_19909_2"});
#line 136
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1307, "When ");
#line hidden
...
#line 139
 testRunner.When("User creates new application ownership component for \'Welcome\' Self Service page " +
                        "via API", ((string)(null)), table1308, "When ");
#line hidden
#line 142
 testRunner.When("User navigates to the \'Builder\' left submenu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
