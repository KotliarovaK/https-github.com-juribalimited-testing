...
#line hidden
                ...
                table1439.AddRow(new string[] {
                            ...
                            "1803 Apps"});
#line 10
    testRunner.When("User creates Self Service via API", ((string)(null)), table1439, "When ");
#line hidden
#line 13
...
#line hidden
                ...
                table1440.AddRow(new string[] {
                            ...
                            "true"});
#line 17
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1440, "When ");
#line hidden
#line 22
...
#line hidden
                ...
                table1441.AddRow(new string[] {
                            ...
                            "1803 Apps"});
#line 28
    testRunner.When("User creates Self Service via API", ((string)(null)), table1441, "When ");
#line hidden
#line 31
    testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1442.AddRow(new string[] {
                            ...
                            "true"});
#line 35
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1442, "When ");
#line hidden
#line 40
 testRunner.When("User navigates to the \'Builder\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 41
    testRunner.Then("User clicks on cogmenu button for item with \'Page\' type and \'TestPageName_1\' name" +
                        " on Self Service Builder Panel and sees the following cogmenu options", ((string)(null)), table1443, "Then ");
#line hidden
