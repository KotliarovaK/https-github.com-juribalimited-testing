...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.SelfService.AdminSide.PrepareForMVP.Builder
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ManageComponents", Description="\tManage Components tests", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\SelfService\\AdminSide\\PrepareForMVP\\Bui" +
        "lder\\ManageComponents.feature", SourceLine=0)]
...
#line 10
 testRunner.When("User create static list with \"SelfServiceStaticAppList\" name on \"Applications\" pa" +
                        "ge with following items", ((string)(null)), table1435, "When ");
#line hidden
...
#line 13
 testRunner.When("User creates Self Service via API and open it", ((string)(null)), table1436, "When ");
#line hidden
                ...
                table1437.AddRow(new string[] {
                            ...
                            "false"});
#line 16
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1437, "When ");
#line hidden
                ...
                table1438.AddRow(new string[] {
                            ...
                            "false"});
#line 19
 testRunner.When("User creates new Self Service Page via API", ((string)(null)), table1438, "When ");
#line hidden
#line 22
