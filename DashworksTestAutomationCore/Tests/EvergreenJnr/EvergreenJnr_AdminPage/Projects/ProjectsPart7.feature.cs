...
#line 10
 testRunner.When("User create static list with \"StaticList6529\" name on \"Users\" page with following" +
                        " items", ((string)(null)), table1038, "When ");
#line hidden
#line 14
...
#line 15
 testRunner.When("User create static list with \"StaticList6530\" name on \"Users\" page with following" +
                        " items", ((string)(null)), table1039, "When ");
#line hidden
#line 19
...
#line 35
 testRunner.When("User expands multiselect and selects following Objects", ((string)(null)), table1040, "When ");
#line hidden
#line 39
...
#line 64
 testRunner.When(string.Format("User create static list with \"{0}\" name on \"{1}\" page with following items", staticList, listName), ((string)(null)), table1041, "When ");
#line hidden
#line 67
...
#line 116
 testRunner.When("User create static list with \"StaticList5846\" name on \"Mailboxes\" page with follo" +
                        "wing items", ((string)(null)), table1042, "When ");
#line hidden
#line 119
...
#line hidden
                ...
                table1043.AddRow(new string[] {
                            string.Format("{0}", item)});
#line 170
 testRunner.When(string.Format("User create static list with \"{0}\" name on \"{1}\" page with following items", staticList, pageName), ((string)(null)), table1043, "When ");
#line hidden
#line 173
 testRunner.Then(string.Format("\"{0}\" list is displayed to user", staticList), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
