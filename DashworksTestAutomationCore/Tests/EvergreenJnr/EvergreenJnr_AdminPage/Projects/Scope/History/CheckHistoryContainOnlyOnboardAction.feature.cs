...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Projects.Scope.History
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("CheckHistoryContainOnlyOnboardAction", Description="\tRuns test related to Grid functionality on history page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Projects\\Scope\\History\\CheckHistoryCont" +
        "ainOnlyOnboardAction.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckHistoryContainOnlyOnboardActionIn2004Rollout", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckHistoryContainOnlyOnboardActionInEmailMigration", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                "DAS13959",
                "Projects"}, SourceLine=25)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckHistoryContainOnlyOnboardActionInUserEvergreenCapacit" +
            "yProject", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
...
#line 49
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Action\' c" +
                        "olumn:", ((string)(null)), table1133, "Then ");
#line hidden
...
#line 54
 testRunner.When("User unchecks following checkboxes in the filter dropdown menu for the \'Action\' c" +
                        "olumn:", ((string)(null)), table1134, "When ");
#line hidden
#line 58
