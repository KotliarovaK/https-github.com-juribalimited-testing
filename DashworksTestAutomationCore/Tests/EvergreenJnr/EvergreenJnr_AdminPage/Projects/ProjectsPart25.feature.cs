...
#line hidden
                ...
                table1073.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 27
 testRunner.When("Project created via API and opened", ((string)(null)), table1073, "When ");
#line hidden
#line 30
 testRunner.When("User navigates to the \'Scope\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table1074.AddRow(new string[] {
                            ...
                            "true"});
#line 66
 testRunner.When("User clicks Group By button and set checkboxes state", ((string)(null)), table1074, "When ");
#line hidden
#line 69
...
#line hidden
                ...
                table1075.AddRow(new string[] {
                            "Shared"});
#line 81
 testRunner.Then("All icon items in the \'Scope\' dropdown have any of tooltip", ((string)(null)), table1075, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                TechTalk.SpecFlow.Table table1076 = new TechTalk.SpecFlow.Table(new string[] {
                            "SelectedValues"});
#line 98
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"{1}\" with added column and Lookup option", filter, @operator), ((string)(null)), table1076, "When ");
#line hidden
#line 100
