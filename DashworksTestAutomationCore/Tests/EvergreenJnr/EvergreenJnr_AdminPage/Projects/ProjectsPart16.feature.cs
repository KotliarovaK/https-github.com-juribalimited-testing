...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Projects
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ProjectsPart16", Description="\tRuns Projects related tests on Admin page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Projects\\ProjectsPart16.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_ChecksThatOnboardedObjectsWorkCorrectlyForTwoUsers", new string[] {
                "Evergreen",
                "Admin",
...
#line hidden
                ...
                table965.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 10
 testRunner.When("Project created via API and opened", ((string)(null)), table965, "When ");
#line hidden
#line 13
...
#line hidden
                ...
                table966.AddRow(new string[] {
                            "03U75EKEMUQMUS"});
#line 17
 testRunner.When("User expands multiselect and selects following Objects", ((string)(null)), table966, "When ");
#line hidden
#line 44
...
#line 50
 testRunner.And("User selects following Objects from the expandable multiselect", ((string)(null)), table967, "And ");
#line hidden
#line 77
...
#line 79
 testRunner.And("User selects following Objects from the expandable multiselect", ((string)(null)), table968, "And ");
#line hidden
#line 106
 testRunner.And("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table969.AddRow(new string[] {
                            "019BFPQGKK5QT8N"});
#line 114
 testRunner.And("following objects were not found", ((string)(null)), table969, "And ");
#line hidden
#line 117
 testRunner.When("User navigates to the \'Users\' tab on Project Scope Changes page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table970.AddRow(new string[] {
                            "AAC860150 (Kerrie D. Ruiz)"});
#line 119
 testRunner.And("following objects were not found", ((string)(null)), table970, "And ");
#line hidden
#line 122
...
#line hidden
                ...
                table971.AddRow(new string[] {
                            "\"WPF/E\" (codename) Community Technology Preview (Feb 2007) (0.8.5.0)"});
#line 124
 testRunner.And("following objects were not found", ((string)(null)), table971, "And ");
#line hidden
#line 128
...
#line 132
 testRunner.And("User create new User", ((string)(null)), table972, "And ");
#line hidden
#line 135
...
#line hidden
                ...
                table973.AddRow(new string[] {
                            ...
                            "1234qwer"});
#line 141
 testRunner.When("User login with following credentials:", ((string)(null)), table973, "When ");
#line hidden
#line 144
...
#line hidden
                ...
                table974.AddRow(new string[] {
                            "019BFPQGKK5QT8N"});
#line 157
 testRunner.And("following objects were not found", ((string)(null)), table974, "And ");
#line hidden
#line 160
 testRunner.When("User navigates to the \'Users\' tab on Project Scope Changes page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table975.AddRow(new string[] {
                            "AAC860150 (Kerrie D. Ruiz)"});
#line 162
 testRunner.And("following objects were not found", ((string)(null)), table975, "And ");
#line hidden
#line 165
 testRunner.When("User navigates to the \'Applications\' tab on Project Scope Changes page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table976.AddRow(new string[] {
                            "\"WPF/E\" (codename) Community Technology Preview (Feb 2007) (0.8.5.0)"});
#line 167
 testRunner.And("following objects were not found", ((string)(null)), table976, "And ");
#line hidden
#line 170
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table977.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 172
 testRunner.When("Project created via API and opened", ((string)(null)), table977, "When ");
#line hidden
#line 175
 testRunner.And("User navigates to the \'Scope\' left menu item", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table978.AddRow(new string[] {
                            "00BDM1JUR8IF419"});
#line 180
 testRunner.And("User selects following Objects from the expandable multiselect", ((string)(null)), table978, "And ");
#line hidden
#line 185
 testRunner.When("User navigates to the \'Users\' tab on Project Scope Changes page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table979.AddRow(new string[] {
                            "AAG081456 (Melanie Z. Fowler)"});
#line 187
 testRunner.And("User selects following Objects from the expandable multiselect", ((string)(null)), table979, "And ");
#line hidden
#line 192
 testRunner.And("User navigates to the \'Applications\' tab on Project Scope Changes page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table980.AddRow(new string[] {
                            "0036 - Microsoft Access 97 SR-2 English (8.0)"});
#line 194
 testRunner.And("User selects following Objects from the expandable multiselect", ((string)(null)), table980, "And ");
#line hidden
#line 199
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckingSortingOrderOfTheObjectsInTheProjectScopeChanges", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
...
#line hidden
                ...
                table981.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 211
 testRunner.When("Project created via API and opened", ((string)(null)), table981, "When ");
#line hidden
#line 214
...
#line 219
 testRunner.When("User selects following Objects from the expandable multiselect", ((string)(null)), table982, "When ");
#line hidden
#line 224
...
#line hidden
                ...
                table983.AddRow(new string[] {
                            "003F5D8E1A844B1FAA5@bclabs.local (Hunter, Melanie)"});
#line 227
 testRunner.Then("following objects were not found", ((string)(null)), table983, "Then ");
#line hidden
#line 232
 testRunner.Then("Objects are displayed in alphabetical order on the Admin page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatSelectAllCheckboxIsWorkingCorrectlyOnAdminPage", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
...
#line hidden
                ...
                table984.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 240
 testRunner.When("Project created via API and opened", ((string)(null)), table984, "When ");
#line hidden
                ...
                table985.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 243
 testRunner.And("Project created via API and opened", ((string)(null)), table985, "And ");
#line hidden
                ...
                table986.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 246
 testRunner.And("Project created via API and opened", ((string)(null)), table986, "And ");
#line hidden
#line 249
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table987.AddRow(new string[] {
                            "001Checkbox11758"});
#line 257
 testRunner.When("User select \"Project\" rows in the grid", ((string)(null)), table987, "When ");
#line hidden
#line 260
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreating" +
            "ProjectFromTheMainLists, Devices", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "DAS12999",
                "DAS13429",
                "Cleanup"}, SourceLine=292)]
        public virtual void EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists_Devices()
        {
#line 271
this.EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists("Devices", "Hostname", "TestList6589", ((string[])(null)));
#line hidden
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreating" +
            "ProjectFromTheMainLists, Users", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "DAS13429",
                "Cleanup"}, SourceLine=292)]
        public virtual void EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists_Users()
        {
#line 271
this.EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists("Users", "Username", "TestList6588", ((string[])(null)));
#line hidden
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreating" +
            "ProjectFromTheMainLists, Mailboxes", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "DAS13429",
                "Cleanup"}, SourceLine=292)]
        public virtual void EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists_Mailboxes()
        {
#line 271
this.EvergreenJnr_AdminPage_CheckThatTheEditListFunctionIsHiddenAfterCancelingCreatingProjectFromTheMainLists("Mailboxes", "Email Address", "TestList6587", ((string[])(null)));
#line hidden
        }
