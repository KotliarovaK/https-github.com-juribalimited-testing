...
#line hidden
                ...
                table986.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 22
 testRunner.When("Project created via API and opened", ((string)(null)), table986, "When ");
#line hidden
#line 25
 testRunner.When("User clicks \'Admin\' on the left-hand menu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 34
 testRunner.When(string.Format("User create static list with \"{0}\" name on \"{1}\" page with following items", staticList, pageName), ((string)(null)), table987, "When ");
#line hidden
#line 37
...
#line 94
 testRunner.When("User create static list with \"StaticList4581\" name on \"Devices\" page with followi" +
                        "ng items", ((string)(null)), table988, "When ");
#line hidden
#line 98
...
#line hidden
                ...
                table989.AddRow(new string[] {
                            "Import Readiness"});
#line 147
 testRunner.And("User checks following checkboxes:", ((string)(null)), table989, "And ");
#line hidden
#line 150
