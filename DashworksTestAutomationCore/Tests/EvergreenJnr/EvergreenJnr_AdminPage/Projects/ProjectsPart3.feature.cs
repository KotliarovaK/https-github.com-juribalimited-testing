...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_AdminPage.Projects
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ProjectsPart3", Description="\tRuns Projects related tests on Admin page", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_AdminPage\\Projects\\ProjectsPart3.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckingThatRedBannerWithOkMessageIsNotDisplayedAfterAddin" +
...
#line hidden
                ...
                table1081.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 10
 testRunner.When("Project created via API and opened", ((string)(null)), table1081, "When ");
#line hidden
#line 13
...
#line 30
 testRunner.When("User expands multiselect and selects following Objects", ((string)(null)), table1084, "When ");
#line hidden
#line 33
...
#line 60
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"Equals\" with added column and Lookup option", filterName), ((string)(null)), table1085, "When ");
#line hidden
#line 63
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProject" +
            "AfterTheChangeCustomList, Devices", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "Cleanup",
                "Project_Creation_and_Scope",
                "Projects"}, SourceLine=74)]
        public virtual void EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList_Devices()
        {
#line 40
this.EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList("Devices", "Hostname", "ProjectList4587", "17,279", "TestProject4511", "17279", "Device Type", "Desktop", "8,100", "8100", "TestProject4511", ((string[])(null)));
#line hidden
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProject" +
            "AfterTheChangeCustomList, Users", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "Project_Creation_and_Scope",
                "Projects"}, SourceLine=74)]
        public virtual void EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList_Users()
        {
#line 40
this.EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList("Users", "Username", "ProjectList4511", "41,339", "TestProject4512", "41339", "Domain", "CORP", "103", "103", "TestProject4512", ((string[])(null)));
#line hidden
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProject" +
            "AfterTheChangeCustomList, Mailboxes", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
                "AdminPage",
                ...
                "Project_Creation_and_Scope",
                "Projects"}, SourceLine=74)]
        public virtual void EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList_Mailboxes()
        {
#line 40
this.EvergreenJnr_AdminPage_CheckThatNumberOfObjectIsUpdatedInTheScopeChangesOfProjectAfterTheChangeCustomList("Mailboxes", "Email Address", "ProjectList4548", "14,884", "TestProject4513", "14884", "Owner City", "London", "3,294", "3294", "TestProject4513", ((string[])(null)));
#line hidden
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckThatObjectsIsOnboardedToTheProjectWithCloneEvergreenB" +
...
#line hidden
                ...
                table1086.AddRow(new string[] {
                            "01BQIYGGUW5PRP6"});
#line 96
 testRunner.And("User expands multiselect and selects following Objects", ((string)(null)), table1086, "And ");
#line hidden
#line 99
 testRunner.And("User clicks \'UPDATE ALL CHANGES\' button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table1087.AddRow(new string[] {
                            "01BQIYGGUW5PRP6"});
#line 105
 testRunner.Then("following Items are displayed in the Queue table", ((string)(null)), table1087, "Then ");
#line hidden
#line 108
...
#line hidden
                ...
                table1088.AddRow(new string[] {
                            "01BQIYGGUW5PRP6"});
#line 111
 testRunner.Then("following Items are displayed in the History table", ((string)(null)), table1088, "Then ");
#line hidden
#line 114
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_AdminPage_CheckingThatProjectDetailsForOnboardedObjectsIsDisplayedCo" +
            "rrectly", new string[] {
                "Evergreen",
                "Admin",
                "EvergreenJnr_AdminPage",
...
#line hidden
                ...
                table1089.AddRow(new string[] {
                            ...
                            "Standalone Project"});
#line 121
 testRunner.When("Project created via API and opened", ((string)(null)), table1089, "When ");
#line hidden
#line 124
...
#line 145
 testRunner.When("User expands multiselect and selects following Objects", ((string)(null)), table1092, "When ");
#line hidden
#line 149
...
#line hidden
                ...
                table1093.AddRow(new string[] {
                            "ACDSee 8"});
#line 160
 testRunner.Then("following Items are displayed in the Queue table", ((string)(null)), table1093, "Then ");
#line hidden
#line 168
...
#line hidden
                ...
                table1095.AddRow(new string[] {
                            "ACDSee 8"});
#line 212
 testRunner.Then("Following items displayed in the History table", ((string)(null)), table1095, "Then ");
#line hidden
#line 220
 testRunner.Then("Counter shows \"6\" found rows", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table1096.AddRow(new string[] {
                            "30 Jul 2017"});
#line 243
 testRunner.When("User selects following date filter on the Projects page", ((string)(null)), table1096, "When ");
#line hidden
#line 246
 testRunner.Then("Rows counter shows \"0\" of \"6\" rows", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
