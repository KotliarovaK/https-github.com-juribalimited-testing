...
#line 12
 testRunner.And("following items are displayed in the top bar:", ((string)(null)), table3269, "And ");
#line hidden
            }
...
#line hidden
                ...
                table3270.AddRow(new string[] {
                            "Workflow"});
#line 24
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3270, "Then ");
#line hidden
#line 30
...
#line hidden
                ...
                table3271.AddRow(new string[] {
                            "Task Readiness"});
#line 31
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3271, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3272.AddRow(new string[] {
                            "Task Readiness"});
#line 42
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3272, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 63
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table3273, "Then ");
#line hidden
                ...
                table3274.AddRow(new string[] {
                            ...
                            string.Format("{0}", value)});
#line 66
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3274, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3276.AddRow(new string[] {
                            ...
                            "GREY"});
#line 86
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3276, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
