...
#line 12
 testRunner.And("following items are displayed in the top bar:", ((string)(null)), table3304, "And ");
#line hidden
            }
...
#line hidden
                ...
                table3305.AddRow(new string[] {
                            "Workflow"});
#line 24
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3305, "Then ");
#line hidden
#line 30
...
#line hidden
                ...
                table3306.AddRow(new string[] {
                            "Task Readiness"});
#line 31
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3306, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3307.AddRow(new string[] {
                            "Task Readiness"});
#line 42
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3307, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3309.AddRow(new string[] {
                            ...
                            string.Format("{0}", value)});
#line 66
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3309, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3311.AddRow(new string[] {
                            ...
                            "GREY"});
#line 86
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3311, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
