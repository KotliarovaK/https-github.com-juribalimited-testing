...
#line 12
 testRunner.And("following items are displayed in the top bar:", ((string)(null)), table3295, "And ");
#line hidden
            }
...
#line hidden
                ...
                table3296.AddRow(new string[] {
                            "Workflow"});
#line 24
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3296, "Then ");
#line hidden
#line 30
...
#line hidden
                ...
                table3297.AddRow(new string[] {
                            "Task Readiness"});
#line 31
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3297, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3298.AddRow(new string[] {
                            "Task Readiness"});
#line 42
 testRunner.Then("following items are displayed in the top bar:", ((string)(null)), table3298, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 63
 testRunner.Then("following content is displayed on the Details Page", ((string)(null)), table3299, "Then ");
#line hidden
                ...
                table3300.AddRow(new string[] {
                            ...
                            string.Format("{0}", value)});
#line 66
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3300, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3302.AddRow(new string[] {
                            ...
                            "GREY"});
#line 86
 testRunner.Then("following items and colors are displayed in the top bar:", ((string)(null)), table3302, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
