...
#line 22
 testRunner.When("User clicks following checkboxes from Column Settings panel for the \'Current App\'" +
                        " column:", ((string)(null)), table3249, "When ");
#line hidden
...
#line 51
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Rationali" +
                        "sation\' column:", ((string)(null)), table3251, "Then ");
#line hidden
#line 54
...
#line hidden
                ...
                table3252.AddRow(new string[] {
                            "UNCATEGORISED"});
#line 55
 testRunner.Then("\'Rationalisation\' column contains following content", ((string)(null)), table3252, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
