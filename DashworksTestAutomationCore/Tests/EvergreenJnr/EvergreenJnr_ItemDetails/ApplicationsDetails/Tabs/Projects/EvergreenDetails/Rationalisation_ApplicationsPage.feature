...
Scenario: EvergreenJnr_ApplicationsList_CheckThatRationalisationIsWorksCorrectlyIfAppIsAleadyOnboardedAndNotKeep
	...
	When User clicks on edit button for 'Rationalisation' field
	When User selects 'FORWARD PATH' in the 'Rationalisation' dropdown
	When User enters 'Assessments on Server' in the 'Application' autocomplete field and selects 'Microsoft Assessments on Server 10.1.10586.0 (3716)' value
...
Scenario: EvergreenJnr_ApplicationsList_CheckThatRationalisationIsWorksCorrectlyIfAppIsAleadyOnboardedAndIsKeep
	When User navigates to the 'Application' details page for the item with '3806' ID
