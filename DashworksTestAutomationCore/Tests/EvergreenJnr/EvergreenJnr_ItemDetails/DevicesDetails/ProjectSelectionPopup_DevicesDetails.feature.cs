...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_ItemDetails.DevicesDetails
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ProjectSelectionPopup_DevicesDetails", Description="\tRuns related tests for Project selection popup", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_ItemDetails\\DevicesDetails\\ProjectSelectionPopup_" +
        "DevicesDetails.feature", SourceLine=0)]
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_DevicesList_CheckThatProjectSelectionPopupForDevicesDetailsPageIsWor" +
            "kingCorrectly", new string[] {
                "Evergreen",
                "Devices",
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_DevicesList_CheckThatTabRedirectionIsWorkedCorrectlyAfterSwitchingFr" +
            "omProjectsToEvergreenModes", new string[] {
                "Evergreen",
                "Devices",
                "EvergreenJnr_ItemDetails",
                "ProjectsTab",
