...
#line 10
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", pageName), ((string)(null)), table3209, "When ");
#line hidden
                ...
                table3210.AddRow(new string[] {
                            string.Format("{0}", column)});
#line 13
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table3210, "Then ");
#line hidden
#line 16
