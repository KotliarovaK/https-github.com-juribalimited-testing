...
#line hidden
                ...
                table3131.AddRow(new string[] {
                            ...
                            "true"});
#line 39
 testRunner.When("User clicks Group By button and set checkboxes state", ((string)(null)), table3131, "When ");
#line hidden
#line 42
 testRunner.Then("Grid is grouped", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table3133.AddRow(new string[] {
                            ...
                            "true"});
#line 64
 testRunner.When("User clicks Group By button and set checkboxes state", ((string)(null)), table3133, "When ");
#line hidden
#line 67
 testRunner.Then("Grid is grouped", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 77
 testRunner.When("User clicks following checkboxes from Column Settings panel for the \'Collection\' " +
                        "column:", ((string)(null)), table3134, "When ");
#line hidden
