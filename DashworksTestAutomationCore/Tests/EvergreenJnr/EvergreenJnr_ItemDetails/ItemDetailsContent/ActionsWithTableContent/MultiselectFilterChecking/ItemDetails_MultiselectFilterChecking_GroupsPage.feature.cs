...
namespace DashworksTestAutomationCore.Tests.EvergreenJnr.EvergreenJnr_ItemDetails.ItemDetailsContent.ActionsWithTableContent.MultiselectFilterChecking
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("ItemDetails_MultiselectFilterChecking_GroupsPage", Description="\tRuns Multiselect Filter Checking for Groups Page related tests", SourceFile="Tests\\EvergreenJnr\\EvergreenJnr_ItemDetails\\ItemDetailsContent\\ActionsWithTableCo" +
        "ntent\\MultiselectFilterChecking\\ItemDetails_MultiselectFilterChecking_GroupsPage" +
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_GroupsList_CheckThatOnlyValueIncludedInTheColumnIsDisplayedInTheRela" +
            "tedMultiselectFilterForMembersTabOnGroupsPage", new string[] {
                "Evergreen",
                "Groups",
...
#line 22
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Domain\' c" +
                        "olumn:", ((string)(null)), table3149, "Then ");
#line hidden
...
#line 25
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Enabled\' " +
                        "column:", ((string)(null)), table3150, "Then ");
#line hidden
...
#line 28
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Directory" +
                        " Type\' column:", ((string)(null)), table3151, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_GroupsList_CheckThatGridIsDisplayedCorrectlyOnApplicationTabCollecti" +
            "onsSubTabForGroupPage", new string[] {
                "Evergreen",
                "Groups",
                "EvergreenJnr_ItemDetails",
                "ItemDetailsDisplay",
                "DAS20490",
                "Zion_NewGrid"}, SourceLine=32)]
...
#line hidden
                ...
                table3152.AddRow(new string[] {
                            "All User Groups"});
#line 39
 testRunner.Then("Content in the \'Collection\' column is equal to", ((string)(null)), table3152, "Then ");
#line hidden
                ...
                table3153.AddRow(new string[] {
                            "JuribaDEV50"});
#line 43
 testRunner.Then("Content in the \'Site\' column is equal to", ((string)(null)), table3153, "Then ");
#line hidden
                ...
                table3154.AddRow(new string[] {
                            "SMS/SCCM 2007"});
#line 47
 testRunner.Then("Content in the \'Import Type\' column is equal to", ((string)(null)), table3154, "Then ");
#line hidden
                ...
                table3155.AddRow(new string[] {
                            "DC1 SMS (DEV50)"});
#line 51
 testRunner.Then("Content in the \'Import\' column is equal to", ((string)(null)), table3155, "Then ");
#line hidden
...
#line 55
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Collectio" +
                        "n\' column:", ((string)(null)), table3156, "Then ");
#line hidden
...
#line 59
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Site\' col" +
                        "umn:", ((string)(null)), table3157, "Then ");
#line hidden
...
#line 62
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Import Ty" +
                        "pe\' column:", ((string)(null)), table3158, "Then ");
#line hidden
...
#line 65
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Import\' c" +
                        "olumn:", ((string)(null)), table3159, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_GroupsList_CheckThatGridIsDisplayedCorrectlyOnApplicationTabApplicat" +
            "ionsSubTabForGroupPage", new string[] {
                "Evergreen",
                "Groups",
                "EvergreenJnr_ItemDetails",
                "ItemDetailsDisplay",
                "DAS20489",
                "Zion_NewGrid"}, SourceLine=69)]
...
#line hidden
                ...
                table3160.AddRow(new string[] {
                            "Program"});
#line 76
 testRunner.Then("ColumnName is displayed in following order on the Details page:", ((string)(null)), table3160, "Then ");
#line hidden
#line 86
...
#line 94
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Complianc" +
                        "e\' column:", ((string)(null)), table3161, "Then ");
#line hidden
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("EvergreenJnr_GroupsList_CheckThatGridIsDisplayedCorrectlyOnMembersTabDeviceMember" +
            "sSubTabForGroupPage", new string[] {
                "Evergreen",
                "Groups",
                "EvergreenJnr_ItemDetails",
                "ItemDetailsDisplay",
...
#line hidden
                ...
                table3163.AddRow(new string[] {
                            "Operating System"});
#line 109
 testRunner.Then("ColumnName is displayed in following order on the Details page:", ((string)(null)), table3163, "Then ");
#line hidden
#line 115
...
#line 120
 testRunner.Then("following checkboxes are displayed in the filter dropdown menu for the \'Operating" +
                        " System\' column:", ((string)(null)), table3164, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
