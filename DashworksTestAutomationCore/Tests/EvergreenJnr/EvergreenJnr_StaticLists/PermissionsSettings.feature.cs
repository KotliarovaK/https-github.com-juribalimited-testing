...
#line 11
 testRunner.When("User create static list with \"Static List TestName23\" name on \"Users\" page with f" +
                        "ollowing items", ((string)(null)), table3775, "When ");
#line hidden
#line 14
...
#line hidden
                ...
                table3776.AddRow(new string[] {
                            "Last Logon Date"});
#line 21
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table3776, "When ");
#line hidden
                ...
                table3777.AddRow(new string[] {
                            "Last Logon Date"});
#line 24
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table3777, "Then ");
#line hidden
#line 27
...
#line 32
 testRunner.When("User create new User via API", ((string)(null)), table3778, "When ");
#line hidden
...
#line 35
 testRunner.When("User create static list with \"OwnerPrivate\" name on \"Devices\" page with following" +
                        " items", ((string)(null)), table3779, "When ");
#line hidden
#line 41
...
#line 95
 testRunner.When("User create static list with \"NotOwnerEveryoneCanEdit\" name on \"Devices\" page wit" +
                        "h following items", ((string)(null)), table3783, "When ");
#line hidden
#line 101
...
#line 108
 testRunner.When("User create static list with \"NotOwnerEveryoneCanSee\" name on \"Devices\" page with" +
                        " following items", ((string)(null)), table3784, "When ");
#line hidden
#line 114
...
#line hidden
                ...
                table3785.AddRow(new string[] {
                            "OwnerPrivate"});
#line 125
 testRunner.Then("following Values are displayed in the \'Choose static list\' dropdown:", ((string)(null)), table3785, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
