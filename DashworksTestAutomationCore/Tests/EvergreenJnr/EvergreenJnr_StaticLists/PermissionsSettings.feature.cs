...
#line 11
 testRunner.When("User create static list with \"Static List TestName23\" name on \"Users\" page with f" +
                        "ollowing items", ((string)(null)), table3736, "When ");
#line hidden
#line 14
...
#line hidden
                ...
                table3737.AddRow(new string[] {
                            "Last Logon Date"});
#line 21
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table3737, "When ");
#line hidden
                ...
                table3738.AddRow(new string[] {
                            "Last Logon Date"});
#line 24
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table3738, "Then ");
#line hidden
#line 27
...
#line 32
 testRunner.When("User create new User via API", ((string)(null)), table3739, "When ");
#line hidden
...
#line 35
 testRunner.When("User create static list with \"OwnerPrivate\" name on \"Devices\" page with following" +
                        " items", ((string)(null)), table3740, "When ");
#line hidden
#line 41
...
#line 44
 testRunner.When("User create static list with \"NotOwnerSpecifiedAdmin\" name on \"Devices\" page with" +
                        " following items", ((string)(null)), table3741, "When ");
#line hidden
#line 50
...
#line 61
 testRunner.When("User create static list with \"NotOwnerSpecifiedEdit\" name on \"Devices\" page with " +
                        "following items", ((string)(null)), table3742, "When ");
#line hidden
#line 67
...
#line 78
 testRunner.When("User create static list with \"NotOwnerSpecifiedRead\" name on \"Devices\" page with " +
                        "following items", ((string)(null)), table3743, "When ");
#line hidden
#line 84
...
#line 95
 testRunner.When("User create static list with \"NotOwnerEveryoneCanEdit\" name on \"Devices\" page wit" +
                        "h following items", ((string)(null)), table3744, "When ");
#line hidden
#line 101
...
#line 108
 testRunner.When("User create static list with \"NotOwnerEveryoneCanSee\" name on \"Devices\" page with" +
                        " following items", ((string)(null)), table3745, "When ");
#line hidden
#line 114
...
#line hidden
                ...
                table3746.AddRow(new string[] {
                            "OwnerPrivate"});
#line 125
 testRunner.Then("following Values are displayed in the \'Choose static list\' dropdown:", ((string)(null)), table3746, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
