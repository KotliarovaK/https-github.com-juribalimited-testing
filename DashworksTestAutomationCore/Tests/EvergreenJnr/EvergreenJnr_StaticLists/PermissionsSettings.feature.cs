...
#line 11
 testRunner.When("User create static list with \"Static List TestName23\" name on \"Users\" page with f" +
                        "ollowing items", ((string)(null)), table3755, "When ");
#line hidden
#line 14
...
#line hidden
                ...
                table3756.AddRow(new string[] {
                            "Last Logon Date"});
#line 21
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table3756, "When ");
#line hidden
                ...
                table3757.AddRow(new string[] {
                            "Last Logon Date"});
#line 24
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table3757, "Then ");
#line hidden
#line 27
...
#line 32
 testRunner.When("User create new User via API", ((string)(null)), table3758, "When ");
#line hidden
...
#line 35
 testRunner.When("User create static list with \"OwnerPrivate\" name on \"Devices\" page with following" +
                        " items", ((string)(null)), table3759, "When ");
#line hidden
#line 41
...
#line 44
 testRunner.When("User create static list with \"NotOwnerSpecifiedAdmin\" name on \"Devices\" page with" +
                        " following items", ((string)(null)), table3760, "When ");
#line hidden
#line 50
...
#line 61
 testRunner.When("User create static list with \"NotOwnerSpecifiedEdit\" name on \"Devices\" page with " +
                        "following items", ((string)(null)), table3761, "When ");
#line hidden
#line 67
...
#line 95
 testRunner.When("User create static list with \"NotOwnerEveryoneCanEdit\" name on \"Devices\" page wit" +
                        "h following items", ((string)(null)), table3763, "When ");
#line hidden
#line 101
...
#line hidden
                ...
                table3765.AddRow(new string[] {
                            "OwnerPrivate"});
#line 125
 testRunner.Then("following Values are displayed in the \'Choose static list\' dropdown:", ((string)(null)), table3765, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
