...
#line 16
 testRunner.Then("User enters SearchCriteria into the agGrid Search Box and the correct NumberOfRow" +
                        "s are returned", ((string)(null)), table2779, "Then ");
#line hidden
#line 19
 testRunner.Then("\'Owner Display Name\' column is \'Left\' Pinned", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table2780.AddRow(new string[] {
                            "Compliance"});
#line 27
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2780, "When ");
#line hidden
#line 30
...
#line 33
 testRunner.Then("User enters SearchCriteria into the agGrid Search Box and the correct NumberOfRow" +
                        "s are returned", ((string)(null)), table2781, "Then ");
#line hidden
#line 36
 testRunner.Then("\'Compliance\' column is \'Right\' Pinned", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table2782.AddRow(new string[] {
                            "Boot Up Date"});
#line 44
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2782, "When ");
#line hidden
#line 48
...
#line 59
 testRunner.When("User add \"Windows7Mi: Category\" filter where type is \"Equals\" with added column a" +
                        "nd following checkboxes:", ((string)(null)), table2784, "When ");
#line hidden
...
#line hidden
                ...
                table2786.AddRow(new string[] {
                            "Email Address"});
#line 74
 testRunner.When("User add following columns using URL to the \"Users\" page:", ((string)(null)), table2786, "When ");
#line hidden
#line 78
...
#line hidden
                ...
                table2787.AddRow(new string[] {
                            "Compliance"});
#line 82
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table2787, "Then ");
#line hidden
                ...
                table2788.AddRow(new string[] {
                            "User Key"});
#line 89
 testRunner.When("User add following columns using current URL on \"Users\" page:", ((string)(null)), table2788, "When ");
#line hidden
                ...
                table2789.AddRow(new string[] {
                            "User Key"});
#line 92
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table2789, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2790.AddRow(new string[] {
                            "Import Type"});
#line 103
 testRunner.When("User add following columns using URL to the \"Mailboxes\" page:", ((string)(null)), table2790, "When ");
#line hidden
#line 107
...
#line hidden
                ...
                table2791.AddRow(new string[] {
                            "Import Type"});
#line 108
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table2791, "Then ");
#line hidden
#line 117
...
#line hidden
                ...
                table2792.AddRow(new string[] {
                            "Import Type"});
#line 118
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table2792, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table2793.AddRow(new string[] {
                            "Application"});
#line 136
 testRunner.And("ColumnName is removed from the list", ((string)(null)), table2793, "And ");
#line hidden
                ...
                table2794.AddRow(new string[] {
                            "Version"});
#line 139
 testRunner.Then("grid headers are displayed in the following order", ((string)(null)), table2794, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 170
 testRunner.Then("ColumnName is removed from the list", ((string)(null)), table2795, "Then ");
#line hidden
                ...
                table2796.AddRow(new string[] {
                            string.Format("{0}", columnName)});
#line 173
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table2796, "When ");
#line hidden
                ...
                table2797.AddRow(new string[] {
                            string.Format("{0}", columnName)});
#line 176
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table2797, "Then ");
#line hidden
#line 179
 testRunner.And("Save to New Custom List element is NOT displayed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
