...
#line hidden
                ...
                table1759.AddRow(new string[] {
                            "Device Key"});
#line 10
 testRunner.When("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table1759, "When ");
#line hidden
                ...
                table1760.AddRow(new string[] {
                            "Device Key"});
#line 13
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1760, "Then ");
#line hidden
            }
...
#line 19
 testRunner.When("User add following columns using URL to the \"Mailboxes\" page:", ((string)(null)), table1761, "When ");
#line hidden
#line 22
...
#line 32
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"Not empty\" with added column and following v" +
                            "alue:", filterName), ((string)(null)), table1762, "When ");
#line hidden
#line 35
...
#line 36
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1763, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 47
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1764, "When ");
#line hidden
                ...
                table1765.AddRow(new string[] {
                            "UserSchedu: Readiness"});
#line 51
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1765, "Then ");
#line hidden
#line 55
...
#line 65
 testRunner.When("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1766, "When ");
#line hidden
#line 68
 testRunner.Then("There are no errors in the browser console", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 78
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1767, "When ");
#line hidden
#line 81
...
#line hidden
                ...
                table1768.AddRow(new string[] {
                            "UserSchedu: Readiness ID"});
#line 82
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1768, "Then ");
#line hidden
#line 85
 testRunner.When("User clicks on \'UserSchedu: Readiness ID\' column header", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 102
 testRunner.When("User add \"Windows7Mi: Rationalisation\" filter where type is \"Equal\" with added co" +
                        "lumn and following checkboxes:", ((string)(null)), table1769, "When ");
#line hidden
#line 105
...
#line 106
 testRunner.When("User add \"Windows7Mi: In Scope\" filter where type is \"Equal\" with added column an" +
                        "d following checkboxes:", ((string)(null)), table1770, "When ");
#line hidden
#line 109
...
#line 115
 testRunner.Then("Content is empty in the column", ((string)(null)), table1771, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 142
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"Equals\" with added column and following chec" +
                            "kboxes:", filterName), ((string)(null)), table1774, "When ");
#line hidden
#line 149
 testRunner.Then(string.Format("\"{0}\" filter is added to the list", filterName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table1775.AddRow(new string[] {
                            string.Format("{0}", columnName)});
#line 170
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1775, "When ");
#line hidden
...
#line hidden
                ...
                table1777.AddRow(new string[] {
                            "Evergreen Bucket"});
#line 191
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1777, "And ");
#line hidden
...
#line hidden
                ...
                table1782.AddRow(new string[] {
                            "Mailbox Count (Access)"});
#line 232
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1782, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 245
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1783, "When ");
#line hidden
                ...
                table1784.AddRow(new string[] {
                            "frscomputerreferencebl"});
#line 249
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1784, "Then ");
#line hidden
#line 253
...
#line 270
 testRunner.When("User add \"EmailMigra: Readiness\" filter where type is \"Equals\" with added column " +
                        "and Lookup option", ((string)(null)), table1785, "When ");
#line hidden
...
#line 280
 testRunner.When("User selects And \"EmailMigra: Readiness\" filter where type is \"Equals\" with added" +
                        " column and Lookup option:", ((string)(null)), table1787, "When ");
#line hidden
#line 283
...
#line hidden
                ...
                table1790.AddRow(new string[] {
                            "Windows7Mi: Language"});
#line 319
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1790, "And ");
#line hidden
                ...
                table1791.AddRow(new string[] {
                            "Windows7Mi: Language"});
#line 322
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1791, "Then ");
#line hidden
#line 325
...
#line hidden
                ...
                table1792.AddRow(new string[] {
                            "Evergreen Ring"});
#line 333
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1792, "And ");
#line hidden
#line 336
...
#line hidden
                ...
                table1793.AddRow(new string[] {
                            string.Format("{0}", filterName)});
#line 348
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1793, "When ");
#line hidden
#line 351
 testRunner.And("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line 352
 testRunner.And(string.Format("User add \"{0}\" filter where type is \"Equals\" with added column and following chec" +
                            "kboxes:", filterName), ((string)(null)), table1794, "And ");
#line hidden
#line 355
...
#line 369
 testRunner.When("User add following columns using URL to the \"Users\" page:", ((string)(null)), table1795, "When ");
#line hidden
#line 372
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 374
 testRunner.When("User add \"Barry\'sUse: In Scope\" filter where type is \"Equals\" without added colum" +
                        "n and following checkboxes:", ((string)(null)), table1796, "When ");
#line hidden
                ...
                table1797.AddRow(new string[] {
                            "Barry\'sUse: Application Readiness"});
#line 377
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1797, "Then ");
#line hidden
#line 380
...
#line hidden
                ...
                table1798.AddRow(new string[] {
                            "2004: Status"});
#line 386
 testRunner.And("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table1798, "And ");
#line hidden
#line 389
...
#line 472
 testRunner.And("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1805, "And ");
#line hidden
...
#line hidden
                ...
                table1807.AddRow(new string[] {
                            "Evergreen Target App Name"});
#line 484
 testRunner.When("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1807, "When ");
#line hidden
...
#line 505
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1809, "When ");
#line hidden
                ...
                table1810.AddRow(new string[] {
                            "Devices_Scope \\ First_Action"});
#line 508
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1810, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1811.AddRow(new string[] {
                            "Compliance"});
#line 523
 testRunner.When("User selects the following Row Groups on Pivot:", ((string)(null)), table1811, "When ");
#line hidden
                ...
                table1812.AddRow(new string[] {
                            "City"});
#line 526
 testRunner.When("User selects the following Columns on Pivot:", ((string)(null)), table1812, "When ");
#line hidden
                ...
                table1813.AddRow(new string[] {
                            "Cost Centre"});
#line 529
 testRunner.When("User selects the following Values on Pivot:", ((string)(null)), table1813, "When ");
#line hidden
#line 532
...
#line hidden
                ...
                table1814.AddRow(new string[] {
                            "Owner Building"});
#line 539
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1814, "When ");
#line hidden
...
#line 552
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1816, "When ");
#line hidden
...
#line hidden
                ...
                table1818.AddRow(new string[] {
                            "In Catalog"});
#line 559
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1818, "When ");
#line hidden
                ...
                table1819.AddRow(new string[] {
                            "In Catalog"});
#line 562
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1819, "Then ");
#line hidden
#line 565
