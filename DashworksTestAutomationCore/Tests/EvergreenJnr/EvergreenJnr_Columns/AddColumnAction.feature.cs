...
#line hidden
                ...
                table1757.AddRow(new string[] {
                            "Device Key"});
#line 10
 testRunner.When("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table1757, "When ");
#line hidden
                ...
                table1758.AddRow(new string[] {
                            "Device Key"});
#line 13
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1758, "Then ");
#line hidden
            }
...
#line 19
 testRunner.When("User add following columns using URL to the \"Mailboxes\" page:", ((string)(null)), table1759, "When ");
#line hidden
#line 22
...
#line 32
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"Not empty\" with added column and following v" +
                            "alue:", filterName), ((string)(null)), table1760, "When ");
#line hidden
#line 35
...
#line 47
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1762, "When ");
#line hidden
                ...
                table1763.AddRow(new string[] {
                            "UserSchedu: Readiness"});
#line 51
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1763, "Then ");
#line hidden
#line 55
...
#line 65
 testRunner.When("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1764, "When ");
#line hidden
#line 68
 testRunner.Then("There are no errors in the browser console", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 78
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1765, "When ");
#line hidden
#line 81
...
#line hidden
                ...
                table1766.AddRow(new string[] {
                            "UserSchedu: Readiness ID"});
#line 82
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1766, "Then ");
#line hidden
#line 85
 testRunner.When("User clicks on \'UserSchedu: Readiness ID\' column header", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 102
 testRunner.When("User add \"Windows7Mi: Rationalisation\" filter where type is \"Equal\" with added co" +
                        "lumn and following checkboxes:", ((string)(null)), table1767, "When ");
#line hidden
#line 105
...
#line 106
 testRunner.When("User add \"Windows7Mi: In Scope\" filter where type is \"Equal\" with added column an" +
                        "d following checkboxes:", ((string)(null)), table1768, "When ");
#line hidden
#line 109
...
#line 115
 testRunner.Then("Content is empty in the column", ((string)(null)), table1769, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table1770.AddRow(new string[] {
                            "User Count"});
#line 125
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1770, "When ");
#line hidden
...
#line 142
 testRunner.When(string.Format("User add \"{0}\" filter where type is \"Equals\" with added column and following chec" +
                            "kboxes:", filterName), ((string)(null)), table1772, "When ");
#line hidden
#line 149
 testRunner.Then(string.Format("\"{0}\" filter is added to the list", filterName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line hidden
                ...
                table1774.AddRow(new string[] {
                            string.Format("{0}", columnName)});
#line 173
 testRunner.Then("ColumnName is added to the list", ((string)(null)), table1774, "Then ");
#line hidden
#line 176
...
#line hidden
                ...
                table1775.AddRow(new string[] {
                            "Evergreen Bucket"});
#line 191
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1775, "And ");
#line hidden
...
#line 245
 testRunner.When("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1781, "When ");
#line hidden
...
#line 270
 testRunner.When("User add \"EmailMigra: Readiness\" filter where type is \"Equals\" with added column " +
                        "and Lookup option", ((string)(null)), table1783, "When ");
#line hidden
...
#line 280
 testRunner.When("User selects And \"EmailMigra: Readiness\" filter where type is \"Equals\" with added" +
                        " column and Lookup option:", ((string)(null)), table1785, "When ");
#line hidden
#line 283
...
#line hidden
                ...
                table1788.AddRow(new string[] {
                            "Windows7Mi: Language"});
#line 319
 testRunner.And("ColumnName is entered into the search box and the selection is clicked", ((string)(null)), table1788, "And ");
#line hidden
...
#line 352
 testRunner.And(string.Format("User add \"{0}\" filter where type is \"Equals\" with added column and following chec" +
                            "kboxes:", filterName), ((string)(null)), table1792, "And ");
#line hidden
#line 355
...
#line 369
 testRunner.When("User add following columns using URL to the \"Users\" page:", ((string)(null)), table1793, "When ");
#line hidden
#line 372
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 374
 testRunner.When("User add \"Barry\'sUse: In Scope\" filter where type is \"Equals\" without added colum" +
                        "n and following checkboxes:", ((string)(null)), table1794, "When ");
#line hidden
                ...
                table1795.AddRow(new string[] {
                            "Barry\'sUse: Application Readiness"});
#line 377
 testRunner.Then("Content is present in the newly added column", ((string)(null)), table1795, "Then ");
#line hidden
#line 380
...
#line hidden
                ...
                table1796.AddRow(new string[] {
                            "2004: Status"});
#line 386
 testRunner.And("User add following columns using URL to the \"Devices\" page:", ((string)(null)), table1796, "And ");
#line hidden
#line 389
...
#line hidden
                ...
                table1797.AddRow(new string[] {
                            "Sticky Compliance"});
#line 397
 testRunner.And("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1797, "And ");
#line hidden
#line 400
...
#line hidden
                ...
                table1805.AddRow(new string[] {
                            "Evergreen Target App Name"});
#line 484
 testRunner.When("User add following columns using URL to the \"Applications\" page:", ((string)(null)), table1805, "When ");
#line hidden
...
#line 505
 testRunner.When(string.Format("User add following columns using URL to the \"{0}\" page:", listName), ((string)(null)), table1807, "When ");
#line hidden
...
#line hidden
                ...
                table1809.AddRow(new string[] {
                            "Compliance"});
#line 523
 testRunner.When("User selects the following Row Groups on Pivot:", ((string)(null)), table1809, "When ");
#line hidden
                ...
                table1810.AddRow(new string[] {
                            "City"});
#line 526
 testRunner.When("User selects the following Columns on Pivot:", ((string)(null)), table1810, "When ");
#line hidden
                ...
                table1811.AddRow(new string[] {
                            "Cost Centre"});
#line 529
 testRunner.When("User selects the following Values on Pivot:", ((string)(null)), table1811, "When ");
#line hidden
#line 532
