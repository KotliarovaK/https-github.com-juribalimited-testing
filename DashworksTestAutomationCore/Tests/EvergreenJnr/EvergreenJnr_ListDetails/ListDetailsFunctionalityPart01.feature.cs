...
#line 41
 testRunner.When("User create new User via API", ((string)(null)), table3032, "When ");
#line hidden
#line 44
 testRunner.When(string.Format("User clicks \'{0}\' on the left-hand menu", pageName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 46
 testRunner.When(string.Format("User create static list with \"STATICListDAS10880\" name on \"{0}\" page with followi" +
                            "ng items", pageName), ((string)(null)), table3033, "When ");
#line hidden
#line 49
...
#line hidden
                ...
                table3034.AddRow(new string[] {
                            ...
                            "m!gration"});
#line 64
 testRunner.When("User is logged in to the Evergreen as", ((string)(null)), table3034, "When ");
#line hidden
#line 67
 testRunner.Then("Evergreen Dashboards page should be displayed to the user", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
