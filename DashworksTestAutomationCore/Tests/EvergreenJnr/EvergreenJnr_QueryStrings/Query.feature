...
Examples:
	| FilterName                                      | QueryString                                                                                                                                                                                                                                   | Rows   |
	| App Count (Entitled)                            | evergreen/#/devices?$filter=(entitledApplications%20%3C%3E%2012)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,entitledApplications&$orderby=entitledApplications%20desc                                                       | 17,028 |
	...
	| App Count (Used)                                | evergreen/#/devices?$filter=(usedApplications%20%3C%2011)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,installedApplications,usedApplications                                                                                 | 16,996 |
...
Examples:
	...
	| App Count (Used)                                | evergreen/#/devices?$filter=(usedApplications%20%3C%3D%20100)&$select=hostname,chassisCategory,oSCategory,ownerDisplayName,usedApplications&$orderby=usedApplications%20desc                                                 | 17,090 | App Count (Used) is less than or equal to 100                                                                                                                                                                                                     |
	| Application                                     | evergreen/#/devices?$filter=(application%20EQUALS%20('4093'%2C'4409'%2C'3854'%2C'3992')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo))                                                                                           | 9      | Application is 7-Zip 16.02 (x64) (4093), 7-Zip 16.04 (x64) (4409), 7-Zip 9.20 (x64 edition) (3854) or 7-Zip 9.22 (x64 edition) (3992) used on device; entitled to device; installed on device; used by device's owner; or entitled to device's owner |
...
Scenario: EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheckForDeviceStaticList
	...
	| Any Application in list - Static - All rows selected | evergreen/#/devices?$filter=(applicationSavedListId%20EQUALS%20('ListName')%20WHERE%20(uod%2Cetd%2Ciod%2Cubdo%2Cetdo)) | StaticList13179 |
...
Scenario: EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheckForDeviceDynamicList
	...
	When Evergreen QueryStringURL is entered for Simple QueryType
	| QueryType                                           | QueryStringURL                                                                                                              | ListName     |
	| Any Application in list - Dynamic - All data sorted | evergreen/#/devices?$filter=(applicationSavedListId%20EQUALS%20('ListName')%20WHERE%20(netdo%2Cnubdo%2Cniod%2Cnetd%2Cnuod)) | Dynamic13179 |
...
Scenario: EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheckForStaticListWithComplianceIsRedAmberOrUnknownFilter
	When Evergreen QueryStringURL is entered for Simple QueryType
	| QueryType                           | QueryStringURL                                                                                                                                               |
	| Compliance is Red, Amber or Unknown | evergreen/#/applications?$filter=(migrationRAG%20EQUALS%20('Red'%2C'Amber'%2C'Unknown'))&$select=packageName,packageManufacturer,packageVersion,migrationRAG |
	...
	When Evergreen QueryStringURL is entered for Simple QueryType
	| QueryType                                                       | QueryStringURL                                                                                | ListName        |
	| Any Application in list StaticList12911 not installed on device | evergreen/#/devices?$filter=(applicationSavedListId%20EQUALS%20('ListName')%20WHERE%20(niod)) | StaticList12911 |
...
Scenario: EvergreenJnr_QueryString_AdvancedFilterRowCountAndFilterTextCheckForStaticListWithVendorContainsMicrosoftOrAdobeFilter
	When Evergreen QueryStringURL is entered for Simple QueryType
	| QueryType                          | QueryStringURL                                                                              |
	| Vendor contains Microsoft or Adobe | evergreen/#/applications?$filter=(packageManufacturer%20CONTAINS%20('Microsoft'%2C'Adobe')) |
	And User create dynamic list with "Dynamic13579" name on "Applications" page
	Then "Dynamic13579" list is displayed to user
	When Evergreen QueryStringURL is entered for Simple QueryType
	| QueryType                                           | QueryStringURL                                                                               | ListName     |
	| Any Application in list Dynamic13579 used on device | evergreen/#/devices?$filter=(applicationSavedListId%20EQUALS%20('ListName')%20WHERE%20(uod)) | Dynamic13579 |
...
Examples:
	...
	| App Count (Used)       | evergreen/#/users?$filter=(usedApplications%20%3C%3D%2010)                                                                             | 41,245 | App Count (Used) is less than or equal to 10                                                                                                                                                                            |
	| Application            | evergreen/#/users?$filter=(application%20EQUALS%20('493')%20WHERE%20(ubu%2Cetu%2Cuodou%2Cetdobu%2Ciodobu))                             | 61     | Application is "WPF/E" (codename) Community Technology Preview (Feb 2007) (493) used by user; entitled to user; used on a device owned by user; entitled to a device owned by user; or installed on a device owned by user | 
