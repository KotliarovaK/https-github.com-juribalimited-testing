...
#line 47
 testRunner.When("User add \"Owner Last Logon Date\" filter where type is \"Between\" without added col" +
                        "umn and Date options", ((string)(null)), table3535, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3539.AddRow(new string[] {
                            ...
                            "NONE"});
#line 72
 testRunner.Then("following values are displayed for \"London\" column on Pivot", ((string)(null)), table3539, "Then ");
#line hidden
#line 78
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 80
 testRunner.When("User add \"Last Logon Date\" filter where type is \"Between\" without added column an" +
                        "d Date options", ((string)(null)), table3540, "When ");
#line hidden
#line 83
...
#line hidden
                ...
                table3544.AddRow(new string[] {
                            ...
                            "GREEN"});
#line 111
 testRunner.Then("following values are displayed for \"TierA Site01\" column on Pivot", ((string)(null)), table3544, "Then ");
#line hidden
#line 117
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line 119
 testRunner.When("User add \"User Last Logon Date\" filter where type is \"Between\" with following Dat" +
                        "e options and Associations:", ((string)(null)), table3545, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3546.AddRow(new string[] {
                            "Floor"});
#line 130
 testRunner.And("User selects the following Row Groups on Pivot:", ((string)(null)), table3546, "And ");
#line hidden
                ...
                table3547.AddRow(new string[] {
                            "Country"});
#line 134
 testRunner.And("User selects the following Columns on Pivot:", ((string)(null)), table3547, "And ");
#line hidden
...
#line 137
 testRunner.And("User selects the following Values on Pivot:", ((string)(null)), table3548, "And ");
#line hidden
#line 140
 testRunner.When("User clicks the Filters button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table3549.AddRow(new string[] {
                            ...
                            "GREEN"});
#line 152
 testRunner.Then("following values are displayed for \"USA\" column on Pivot", ((string)(null)), table3549, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
                ...
                table3550.AddRow(new string[] {
                            "City"});
#line 163
 testRunner.And("User selects the following Row Groups on Pivot:", ((string)(null)), table3550, "And ");
#line hidden
                ...
                table3551.AddRow(new string[] {
                            "Manufacturer"});
#line 167
 testRunner.And("User selects the following Columns on Pivot:", ((string)(null)), table3551, "And ");
#line hidden
                ...
                table3552.AddRow(new string[] {
                            "1803: Readiness"});
#line 170
 testRunner.And("User selects the following Values on Pivot:", ((string)(null)), table3552, "And ");
#line hidden
#line 173
 testRunner.When("User selects aggregate function \"Severity\" on Pivot", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
                ...
                table3553.AddRow(new string[] {
                            ...
                            "BLOCKED"});
#line 177
 testRunner.Then("following values are displayed for \"Asus\" column on Pivot", ((string)(null)), table3553, "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
